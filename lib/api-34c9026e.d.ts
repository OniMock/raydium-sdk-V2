...
declare class TxBuilder {
    ...
    versionBuild<O = Record<string, any>>({ txVersion, extInfo, }: {
        txVersion?: TxVersion;
        extInfo?: O;
    }, nonce?: string): Promise<MakeTxData<TxVersion.LEGACY, O> | MakeTxData<TxVersion.V0, O>>;
    build<O = Record<string, any>>(extInfo?: O, nonce?: string): MakeTxData<TxVersion.LEGACY, O>;
    ...
    buildV0<O = Record<string, any>>(props?: O & {
        ...
        recentBlockhash?: string;
    }, nonce?: string): Promise<MakeTxData<TxVersion.V0, O>>;
