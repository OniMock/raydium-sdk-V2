...
var accountInfo_exports = {};
__export(accountInfo_exports, {
  ACCOUNT_TYPE_SIZE: () => ACCOUNT_TYPE_SIZE,
  AccountType: () => AccountType,
  fetchMultipleMintInfos: () => fetchMultipleMintInfos,
  getMultipleAccountsInfo: () => getMultipleAccountsInfo,
  getMultipleAccountsInfoWithCustomFlags: () => getMultipleAccountsInfoWithCustomFlags
});
module.exports = __toCommonJS(accountInfo_exports);
...
async function fetchMultipleMintInfos({
  ...
  for (const i of mintInfos) {
    if (!i.accountInfo || i.accountInfo.data.length < import_spl_token5.MINT_SIZE) {
      console.log("invalid mint account", i.pubkey.toBase58());
      continue;
    }
    const t = (0, import_spl_token5.unpackMint)(i.pubkey, i.accountInfo, i.accountInfo?.owner);
    mintK[i.pubkey.toString()] = {
      ...t,
      programId: i.accountInfo?.owner || import_spl_token5.TOKEN_PROGRAM_ID,
      feeConfig: (0, import_spl_token5.getTransferFeeConfig)(t) ?? void 0
    };
  }
  mintK[import_web310.PublicKey.default.toBase58()] = mintK[WSOLMint.toBase58()];
  return mintK;
}
