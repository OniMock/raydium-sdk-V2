...
var fractionUtil_exports = {};
__export(fractionUtil_exports, {
  add: () => add2,
  default: () => toFraction,
  div: () => div2,
  eq: () => eq,
...
module.exports = __toCommonJS(fractionUtil_exports);
...
function parseNumberInfo(n) {
  ...
  if (n instanceof import_bn5.default) {
...
var TokenAmount = class extends Fraction {
  ...
  constructor(token, amount, isRaw = true, name) {
    let parsedAmount = new import_bn8.default(0);
    const multiplier = BN_TEN.pow(new import_bn8.default(token.decimals));
    if (isRaw) {
      parsedAmount = parseBigNumberish(amount);
    } else {
      let integralAmount = new import_bn8.default(0);
      let fractionalAmount = new import_bn8.default(0);
