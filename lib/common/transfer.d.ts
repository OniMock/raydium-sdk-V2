...
import { bW as GetTransferAmountFee, T as TransferFeeDataBaseType } from '../api-34c9026e.js';
import 'axios';
...
export { BNDivCeil, ceilDivBN, getTransferAmountFee, getTransferAmountFeeV2, minExpirationTime };
