...
function initTokenAccountInstruction(params) {
  const { mint, tokenAccount, owner, programId = import_spl_token7.TOKEN_PROGRAM_ID } = params;
  return (0, import_spl_token7.createInitializeAccountInstruction)(tokenAccount, mint, owner, programId);
}
function closeAccountInstruction(params) {
  const { tokenAccount, payer, multiSigners = [], owner, programId = import_spl_token7.TOKEN_PROGRAM_ID } = params;
  return (0, import_spl_token7.createCloseAccountInstruction)(tokenAccount, payer, owner, multiSigners, programId);
}
async function createWSolAccountInstructions(params) {
  ...
  const newAccount = generatePubKey({ fromPublicKey: payer, programId: import_spl_token7.TOKEN_PROGRAM_ID });
  return {
...
function makeTransferInstruction({
  ...
  return (0, import_spl_token7.createTransferInstruction)(source, destination, owner, BigInt(String(amount)), multiSigners, tokenProgram);
}
