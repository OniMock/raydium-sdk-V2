...
var NEGATIVE_ONE = new import_bn2.default(-1);
var Q64 = new import_bn2.default(1).shln(64);
var Q128 = new import_bn2.default(1).shln(128);
var MaxU64 = Q64.sub(ONE);
var MaxUint128 = Q128.subn(1);
var MIN_TICK = -443636;
var MAX_TICK = -MIN_TICK;
var MIN_SQRT_PRICE_X64 = new import_bn2.default("4295048016");
var MAX_SQRT_PRICE_X64 = new import_bn2.default("79226673521066979257578248091");
var MIN_SQRT_PRICE_X64_ADD_ONE = new import_bn2.default("4295048017");
var MAX_SQRT_PRICE_X64_SUB_ONE = new import_bn2.default("79226673521066979257578248090");
var FEE_RATE_DENOMINATOR = new import_bn2.default(10).pow(new import_bn2.default(6));
var U64_IGNORE_RANGE = new import_bn2.default("18446744073700000000");
...
function createLogger(moduleName) {
  let logger6 = (0, import_lodash.get)(moduleLoggers, moduleName);
  if (!logger6) {
    const logLevel = (0, import_lodash.get)(moduleLevels, moduleName);
    logger6 = new Logger({ name: moduleName, logLevel });
    (0, import_lodash.set)(moduleLoggers, moduleName, logger6);
  }
  return logger6;
}
...
var Fraction = class {
  numerator;
  denominator;
  constructor(numerator, denominator = new import_bn5.default(1)) {
...
var _100_PERCENT = new Fraction(new import_bn7.default(100));
...
// src/common/bignumber.ts
var BN_ZERO = new import_bn9.default(0);
var BN_ONE = new import_bn9.default(1);
var BN_TWO = new import_bn9.default(2);
var BN_THREE = new import_bn9.default(3);
var BN_FIVE = new import_bn9.default(5);
var BN_TEN = new import_bn9.default(10);
var BN_100 = new import_bn9.default(100);
var BN_1000 = new import_bn9.default(1e3);
var BN_10000 = new import_bn9.default(1e4);
...
var FEE_RATE_DENOMINATOR_VALUE = new import_bn10.default(1e6);
