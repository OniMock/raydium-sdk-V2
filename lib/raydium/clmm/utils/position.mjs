...
var ZERO = new BN9(0);
var ONE = new BN9(1);
var NEGATIVE_ONE = new BN9(-1);
var Q64 = new BN9(1).shln(64);
var Q128 = new BN9(1).shln(128);
var MaxU64 = Q64.sub(ONE);
var U64Resolution = 64;
var MaxUint128 = Q128.subn(1);
var MIN_TICK = -443636;
var MAX_TICK = -MIN_TICK;
var MIN_SQRT_PRICE_X64 = new BN9("4295048016");
var MAX_SQRT_PRICE_X64 = new BN9("79226673521066979257578248091");
var MIN_SQRT_PRICE_X64_ADD_ONE = new BN9("4295048017");
var MAX_SQRT_PRICE_X64_SUB_ONE = new BN9("79226673521066979257578248090");
...
var FEE_RATE_DENOMINATOR = new BN9(10).pow(new BN9(6));
var U64_IGNORE_RANGE = new BN9("18446744073700000000");
...
var PositionUtils = class {
  ...
  static getAmountsFromLiquidity({
    ...
    const [amountSlippageA, amountSlippageB] = [
      getTransferAmountFeeV2(new BN14(new decimal_default(amounts.amountA.toString()).mul(coefficientRe).toFixed(0)), poolInfo.mintA.extensions?.feeConfig, epochInfo, true),
      getTransferAmountFeeV2(new BN14(new decimal_default(amounts.amountB.toString()).mul(coefficientRe).toFixed(0)), poolInfo.mintB.extensions?.feeConfig, epochInfo, true)
    ];
    return {
      liquidity,
      amountA,
