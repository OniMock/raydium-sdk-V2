...
var FARM_PROGRAM_ID_V3 = new PublicKey2("EhhTKczWMGQt46ynNeRX1WfeagwwJd7ufHvCDjRxjo5Q");
var FARM_PROGRAM_ID_V4 = new PublicKey2("CBuCnLe26faBpcBP2fktp4rp8abpcAnTWft6ZrP5Q4T");
var FARM_PROGRAM_ID_V5 = new PublicKey2("9KEPoZmtHUrBbhWN1v1KWLMkkvwY6WLtAVUCPRtRjP4z");
var FARM_PROGRAM_ID_V6 = new PublicKey2("FarmqiPv5eAj3j1GMdMCMUGXqPUvmquZtMy86QH6rzhG");
var UTIL1216 = new PublicKey2("CLaimxFqjHzgTJtAGHU47NPhg6qrc5sCnpC4tBLyABQS");
var OPEN_BOOK_PROGRAM = new PublicKey2("srmqPvymJeFKQ4zGQed1GFppgkRHL9kaELCbyksJtPX");
var SERUM_PROGRAM_ID_V3 = new PublicKey2("9xQeWvG816bUx9EPjHmaT23yvVM2ZWbrrpZb9PusVFin");
var AMM_V4 = new PublicKey2("675kPX9MHTjS2zt1qfr1NYHuzeLXfQM9H24wFSUt1Mp8");
var AMM_STABLE = new PublicKey2("5quBtoiQqxF9Jv6KYKctB59NT3gtJD2Y65kdnB1Uev3h");
var LIQUIDITY_POOL_PROGRAM_ID_V5_MODEL = new PublicKey2("CDSr3ssLcRB6XYPJwAfFt18MZvEZp4LjHcvzBVZ45duo");
var CLMM_PROGRAM_ID = new PublicKey2("CAMMCzo5YL8w4VFF8KVHrK22GGUsp5VTaW7grrKgrWqK");
var CLMM_LOCK_PROGRAM_ID = new PublicKey2("LockrWmn6K5twhz3y9w1dQERbmgSaRkfnTeTKbpofwE");
var CLMM_LOCK_AUTH_ID = new PublicKey2("kN1kEznaF5Xbd8LYuqtEFcxzWSBk5Fv6ygX6SqEGJVy");
var Router = new PublicKey2("routeUGWgWzqBWFcrCfv8tritsqukccJPu3q5GPP3xS");
var FEE_DESTINATION_ID = new PublicKey2("7YttLkHDoNj9wyDur5pM1ejNaAvT9X4eqaYcHQqtj2G5");
var IDO_PROGRAM_ID_V1 = new PublicKey2("6FJon3QE27qgPVggARueB22hLvoh22VzJpXv4rBEoSLF");
var IDO_PROGRAM_ID_V2 = new PublicKey2("CC12se5To1CdEuw7fDS27B7Geo5jJyL7t5UK2B44NgiH");
var IDO_PROGRAM_ID_V3 = new PublicKey2("9HzJyW1qZsEiSfMUf6L2jo3CcTKAyBmSyKdwQeYisHrC");
var IDO_PROGRAM_ID_V4 = new PublicKey2("DropEU8AvevN3UrXWXTMuz3rqnMczQVNjq3kcSdW2SQi");
var CREATE_CPMM_POOL_PROGRAM = new PublicKey2("CPMMoo8L3F4NbTegBCKVNunggL7H1ZpdTHKxQB5qKP1C");
var CREATE_CPMM_POOL_AUTH = new PublicKey2("GpMZbSM2GgvTKHJirzeGfMFoaZ8UR2X7F4v8vHTvxFbL");
var CREATE_CPMM_POOL_FEE_ACC = new PublicKey2("DNXgeM9EiiaAbaWvwjHj9fQQLAX5ZsfHyvmYUNRAdNC8");
var DEV_CREATE_CPMM_POOL_PROGRAM = new PublicKey2("CPMDWBwJDtYax9qW7AyRuVC19Cc4L4Vcy4n2BHAbHkCW");
var DEV_CREATE_CPMM_POOL_AUTH = new PublicKey2("7rQ1QFNosMkUCuh7Z7fPbTHvh73b68sQYdirycEzJVuw");
var DEV_CREATE_CPMM_POOL_FEE_ACC = new PublicKey2("G11FKBRaAkHAKuLCgLM6K6NUc9rTjPAznRCjZifrTQe2");
var LOCK_CPMM_PROGRAM = new PublicKey2("LockrWmn6K5twhz3y9w1dQERbmgSaRkfnTeTKbpofwE");
var DEV_LOCK_CPMM_PROGRAM = new PublicKey2("DLockwT7X7sxtLmGH9g5kmfcjaBtncdbUmi738m5bvQC");
var LOCK_CPMM_AUTH = new PublicKey2("3f7GcQFG397GAaEnv51zR6tsTVihYRydnydDD1cXekxH");
var DEV_LOCK_CPMM_AUTH = new PublicKey2("7AFUeLVRjBfzqK3tTGw8hN48KLQWSk6DTE8xprWdPqix");
var LAUNCHPAD_PROGRAM = new PublicKey2("LanMV9sAd7wArD4vJFi2qDdfnVhFxYSUg6eADduJ3uj");
var LAUNCHPAD_AUTH = new PublicKey2("WLHv2UAZm6z4KyaaELi5pjdbJh6RESMva1Rnn8pJVVh");
var DEV_LAUNCHPAD_PROGRAM = new PublicKey2("LanD8FpTBBvzZFXjTxsAoipkFsxPUCDB4qAqKxYDiNP");
var DEV_LAUNCHPAD_AUTH = new PublicKey2("HYNHiyKJ3gGVFvyxJAurK7qr7P2o5J9THmvCGMdULtpW");
var DEVNET_PROGRAM_ID = {
  SERUM_MARKET: PublicKey2.default,
  OPENBOOK_MARKET: new PublicKey2("EoTcMgcDRTJVZDMZWBoU6rhYHZfkNTVEAfz3uUJRcYGj"),
  UTIL1216: PublicKey2.default,
  FarmV3: new PublicKey2("85BFyr98MbCUU9MVTEgzx1nbhWACbJqLzho6zd6DZcWL"),
  FarmV5: new PublicKey2("EcLzTrNg9V7qhcdyXDe2qjtPkiGzDM2UbdRaeaadU5r2"),
  FarmV6: new PublicKey2("Farm2hJLcqPtPg8M4rR6DMrsRNc5TPm5Cs4bVQrMe2T7"),
  AmmV4: new PublicKey2("HWy1jotHpo6UqeQxx49dpYYdQB8wj9Qk9MdxwjLvDHB8"),
  AmmStable: new PublicKey2("DDg4VmQaJV9ogWce7LpcjBA9bv22wRp5uaTPa5pGjijF"),
  CLMM: new PublicKey2("devi51mZmdwUJGU9hjN27vEz64Gps7uUefqxg27EAtH"),
  CLMM_LOCK_PROGRAM_ID: new PublicKey2("DLockwT7X7sxtLmGH9g5kmfcjaBtncdbUmi738m5bvQC"),
  CLMM_LOCK_AUTH_ID: new PublicKey2("8qmHNvu2Kr2C7U8mJL4Vz1vTDxMhVuXKREwU7TNoaVEo"),
  Router: new PublicKey2("BVChZ3XFEwTMUk1o9i3HAf91H6mFxSwa5X2wFAWhYPhU"),
  ...
  FEE_DESTINATION_ID: new PublicKey2("3XMrhbv989VxAMi3DErLV9eJht1pHppW5LbKxe9fkEFR"),
...
var logger2 = createLogger("Raydium_accountInfo_util");
async function getMultipleAccountsInfo(connection, publicKeys, config2) {
  ...
  if (batchRequest) {
    ...
    results = unsafeResponse.map((unsafeRes) => {
      if (unsafeRes.error)
        logger2.logWithError(`failed to get info for multiple accounts, RPC_ERROR, ${unsafeRes.error.message}`);
      return unsafeRes.result.value.map((accountInfo) => {
        if (accountInfo) {
          const { data, executable, lamports, owner, rentEpoch } = accountInfo;
          if (data.length !== 2 && data[1] !== "base64")
            logger2.logWithError(`info must be base64 encoded, RPC_ERROR`);
          return {
    ...
    try {
      ...
      if (error instanceof Error) {
        logger2.logWithError(`failed to get info for multiple accounts, RPC_ERROR, ${error.message}`);
      }
    }
  }
  return results.flat();
...
// src/module/fraction.ts
var logger3 = createLogger("module/fraction");
...
var Fraction = class {
  numerator;
  denominator;
  constructor(numerator, denominator = new BN3(1)) {
  ...
  toSignificant(significantDigits, format = { groupSeparator: "" }, rounding = 1 /* ROUND_HALF_UP */) {
    if (!Number.isInteger(significantDigits))
      logger3.logWithError(`${significantDigits} is not an integer.`);
    if (significantDigits <= 0)
      logger3.logWithError(`${significantDigits} is not positive.`);
  ...
  toFixed(decimalPlaces, format = { groupSeparator: "" }, rounding = 1 /* ROUND_HALF_UP */) {
    if (!Number.isInteger(decimalPlaces))
      logger3.logWithError(`${decimalPlaces} is not an integer.`);
    if (decimalPlaces < 0)
      logger3.logWithError(`${decimalPlaces} is negative.`);
...
// src/module/amount.ts
var logger4 = createLogger("Raydium_amount");
...
function splitNumber(num, decimals) {
  ...
  if (num.includes(".")) {
    ...
    if (splited.length === 2) {
      ...
      logger4.logWithError(`invalid number string, num: ${num}`);
    }
  } else {
    integral = num;
  }
...
var TokenAmount = class extends Fraction {
  ...
  constructor(token, amount, isRaw = true, name) {
    let parsedAmount = new BN4(0);
    const multiplier = BN_TEN.pow(new BN4(token.decimals));
    if (isRaw) {
      parsedAmount = parseBigNumberish(amount);
    } else {
      let integralAmount = new BN4(0);
      let fractionalAmount = new BN4(0);
...
var SOL_INFO = {
  chainId: 101,
  address: PublicKey5.default.toBase58(),
...
import { PublicKey as PublicKey6, SystemProgram, SYSVAR_RENT_PUBKEY } from "@solana/web3.js";
...
function validateAndParsePublicKey({
  ...
  if (publicKey2 instanceof PublicKey6) {
  ...
  if (typeof publicKey2 === "string") {
    if (publicKey2 === PublicKey6.default.toBase58())
      return PublicKey6.default;
    try {
      const key = new PublicKey6(publicKey2);
      return key;
    } catch {
...
function tryParsePublicKey(v) {
  try {
    return new PublicKey6(v);
  } catch (e) {
    return v;
  }
}
var MEMO_PROGRAM_ID = new PublicKey6("MemoSq4gqABAXKb96qnH8TysNcWxMyWCqXgDLGmfcHr");
var MEMO_PROGRAM_ID2 = new PublicKey6("MemoSq4gqABAXKb96qnH8TysNcWxMyWCqXgDLGmfcHr");
var RENT_PROGRAM_ID = new PublicKey6("SysvarRent111111111111111111111111111111111");
var CLOCK_PROGRAM_ID = new PublicKey6("SysvarC1ock11111111111111111111111111111111");
var METADATA_PROGRAM_ID = new PublicKey6("metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s");
var INSTRUCTION_PROGRAM_ID = new PublicKey6("Sysvar1nstructions1111111111111111111111111");
var SYSTEM_PROGRAM_ID = SystemProgram.programId;
var RAYMint = new PublicKey6("4k3Dyjzvzp8eMZWUXbBCjEvwSkkk59S5iCNLY3QrkX6R");
var PAIMint = new PublicKey6("Ea5SjE2Y6yvCeW5dYTn7PYMuW5ikXkvbGdcmSnXeaLjS");
var SRMMint = new PublicKey6("SRMuApVNdxXokk5GT7XD5cUUgXMBCoAz2LHeuAoKWRt");
var USDCMint = new PublicKey6("EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v");
var USDTMint = new PublicKey6("Es9vMFrzaCERmJfrF4H2FYD4KCoNkY11McCe8BenwNYB");
var mSOLMint = new PublicKey6("mSoLzYCxHdYgdzU16g5QSh3i5K3z3KZK7ytfqcJm7So");
var stSOLMint = new PublicKey6("7dHbWXmci3dT8UFYWYZweBLXgycu7Y3iL6trKn1Y7ARj");
var USDHMint = new PublicKey6("USDH1SM1ojwWUga67PGrgFWUHibbjqMvuMaDkRJTgkX");
var NRVMint = new PublicKey6("NRVwhjBQiUPYtfDT5zRBVJajzFQHaBUNtC7SNVvqRFa");
var ANAMint = new PublicKey6("ANAxByE6G2WjFp7A4NqtWYXb3mgruyzZYg3spfxe6Lbo");
var ETHMint = new PublicKey6("7vfCXTUXx5WJV5JADk17DUJ4ksgau7utNKj4b963voxs");
var WSOLMint = new PublicKey6("So11111111111111111111111111111111111111112");
var SOLMint = PublicKey6.default;
...
var _Token = class {
  ...
  constructor({ mint, decimals, symbol, name, skipMint = false, isToken2022 = false }) {
    if (mint === SOLMint.toBase58() || mint instanceof PublicKey7 && SOLMint.equals(mint)) {
      this.decimals = TOKEN_WSOL.decimals;
      this.symbol = TOKEN_WSOL.symbol;
      this.name = TOKEN_WSOL.name;
      this.mint = new PublicKey7(TOKEN_WSOL.address);
    ...
    this.mint = skipMint ? PublicKey7.default : validateAndParsePublicKey({ publicKey: mint });
...
// src/module/price.ts
var logger5 = createLogger("Raydium_price");
var Price = class extends Fraction {
  ...
  mul(other) {
    if (this.quoteToken !== other.baseToken)
      logger5.logWithError("mul token not equals");
...
function notInnerObject(v) {
  return typeof v === "object" && v !== null && ![Token, TokenAmount, PublicKey8, Fraction, BN6, Price, Percent].some((o) => typeof o === "object" && v instanceof o);
}
...
var logger6 = createLogger("Raydium_txUtil");
function findProgramAddress(seeds, programId) {
  const [publicKey2, nonce] = PublicKey9.findProgramAddressSync(seeds, programId);
  return { publicKey: publicKey2, nonce };
}

// src/common/pda.ts
function getATAAddress(owner, mint, programId) {
  return findProgramAddress([owner.toBuffer(), (programId ?? TOKEN_PROGRAM_ID5).toBuffer(), mint.toBuffer()], new PublicKey10("ATokenGPvbdGVxr1b2hvZbsiqW5xWH25efTNsLJA8knL"));
}
...
import { PublicKey as PublicKey11, AddressLookupTableAccount } from "@solana/web3.js";
var LOOKUP_TABLE_CACHE = {
  "AcL1Vo8oy1ULiavEcjSUcwfBSForXMudcZvDZy5nzJkU": new AddressLookupTableAccount({
    key: new PublicKey11("AcL1Vo8oy1ULiavEcjSUcwfBSForXMudcZvDZy5nzJkU"),
...
function updateFarmPoolInfo(poolInfo, lpVault, slot, chainTime) {
  if (poolInfo.version === 3 || poolInfo.version === 5) {
    if (poolInfo.lastSlot.gte(new BN10(slot)))
      return poolInfo;
    const spread = new BN10(slot).sub(poolInfo.lastSlot);
    poolInfo.lastSlot = new BN10(slot);
    for (const itemRewardInfo of poolInfo.rewardInfos) {
      if (lpVault.amount.eq(new BN10(0)))
        continue;
      const reward = itemRewardInfo.perSlotReward.mul(spread);
      itemRewardInfo.perShareReward = itemRewardInfo.perShareReward.add(reward.mul(new BN10(10).pow(new BN10(poolInfo.version === 3 ? 9 : 15))).div(lpVault.amount));
      itemRewardInfo.totalReward = itemRewardInfo.totalReward.add(reward);
    }
  } else if (poolInfo.version === 6) {
    for (const itemRewardInfo of poolInfo.rewardInfos) {
      if (itemRewardInfo.rewardState.eq(new BN10(0)))
        continue;
      const updateTime = BN10.min(new BN10(chainTime), itemRewardInfo.rewardEndTime);
...
async function fetchMultipleFarmInfoAndUpdate({
  ...
  for (const { pubkey, version, key, poolId, accountInfo } of accountsInfo) {
    ...
    if (key === "state") {
      ...
      if (!accountInfo || !accountInfo.data || accountInfo.data.length !== stateLayout.span)
        logger7.logWithError(`invalid farm state account info, pools.id, ${pubkey}`);
      ...
      if (!accountInfo || !accountInfo.data || accountInfo.data.length !== splAccountLayout.span)
        logger7.logWithError(`invalid farm lp vault account info, pools.lpVault, ${pubkey}`);
      ...
      if (accountInfo && accountInfo.data) {
        if (accountInfo.data.length !== legerLayout.span)
          logger7.logWithError(`invalid farm ledger account info, ledger, ${pubkey}`);
  ...
  for (const [poolId, { state, ledger }] of Object.entries(poolsInfo)) {
    if (ledger) {
      const multiplier = state.version === 6 ? state.rewardMultiplier : state.rewardInfos.length === 1 ? tenBN.pow(new BN10(9)) : tenBN.pow(new BN10(15));
...
function makeCreateFarmInstruction(params) {
  ...
  return {
    instruction: new TransactionInstruction3({ programId: params.programId, keys, data }),
...
async function makeWithdrawTokenInstruction({
  ...
  const ownerInfo = farmLedgerLayoutV3_2.decode(ownerAccountInfo.data);
  if (ownerInfo.voteLockedBalance.eq(new BN11(0))) {
...
function makeRestartRewardInstruction({
  ...
  return new TransactionInstruction3({ programId: farmKeys.programId, keys, data });
}
...
function makeDepositWithdrawInstruction(params) {
  ...
  const keys = version === 6 ? [
    accountMeta({ pubkey: TOKEN_PROGRAM_ID6, isWritable: false }),
    ...deposit ? [accountMeta({ pubkey: SystemProgram3.programId, isWritable: false })] : [],
    accountMeta({ pubkey: id }),
...
function makeWithdrawInstructionV4(params) {
  ...
  const keys = [
    ...
    accountMeta({ pubkey: new PublicKey13(farmKeys.rewardInfos[1].vault) })
  ];
  const data = Buffer.alloc(dataLayout.span);
  dataLayout.encode({
    instruction: 2,
