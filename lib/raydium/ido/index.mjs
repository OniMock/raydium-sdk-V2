...
// src/common/bignumber.ts
var BN_ZERO = new BN4(0);
var BN_ONE = new BN4(1);
var BN_TWO = new BN4(2);
var BN_THREE = new BN4(3);
var BN_FIVE = new BN4(5);
var BN_TEN = new BN4(10);
var BN_100 = new BN4(100);
var BN_1000 = new BN4(1e3);
var BN_10000 = new BN4(1e4);
...
function notInnerObject(v) {
  return typeof v === "object" && v !== null && ![Token, TokenAmount, PublicKey10, Fraction, BN8, Price, Percent].some((o) => typeof o === "object" && v instanceof o);
}
...
import { SYSVAR_CLOCK_PUBKEY, TransactionInstruction as TransactionInstruction3 } from "@solana/web3.js";
...
var MarketV2 = class extends ModuleBase {
  async claim({
    ...
    const [hasUnClaimedProject, hasUnClaimedBuy] = [!new BN10(ownerInfo.coin).isZero(), !new BN10(ownerInfo.pc).isZero()];
        ...
        instructions: [
          ...hasUnClaimedProject ? [
            makeClaimInstruction({ programId: poolConfigKey.programId }, {
              ...
              userIdoInfo: new PublicKey13(ownerInfo.userIdoInfo),
              userOwner: this.scope.ownerPubKey
            })
          ] : [],
          ...hasUnClaimedBuy ? [
            makeClaimInstruction({ programId: new PublicKey13(idoKeys.programId) }, {
              idoId: poolConfigKey.id,
              authority: poolConfigKey.authority,
    ...
    const keys = {
      ...
      userKeys: {
        ...
        ledgerAccount: new PublicKey13(ownerInfo.userIdoInfo),
        owner: this.scope.ownerPubKey
      }
    };
    return txBuilder.addInstruction({
