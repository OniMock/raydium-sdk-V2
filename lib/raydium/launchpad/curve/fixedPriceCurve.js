...
var fixedPriceCurve_exports = {};
__export(fixedPriceCurve_exports, {
  FixedPriceCurve: () => FixedPriceCurve
});
module.exports = __toCommonJS(fixedPriceCurve_exports);
...
var FixedPriceCurve = class extends CurveBase {
  ...
  static getInitParam({
    ...
    if (supplyMinusLocked.lte(new import_bn9.default(0)))
      throw Error("invalid input 1");
    const denominator = new import_bn9.default(2).mul(totalFundRaising).sub(migrateFee);
