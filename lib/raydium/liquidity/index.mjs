...
var BNLayout = class extends Layout {
  ...
  decode(b, offset2 = 0) {
    const num = new BN2(this.blob.decode(b, offset2), 10, "le");
    if (this.signed) {
...
function createLogger(moduleName) {
  let logger9 = get(moduleLoggers, moduleName);
  if (!logger9) {
    const logLevel = get(moduleLevels, moduleName);
    logger9 = new Logger({ name: moduleName, logLevel });
    set(moduleLoggers, moduleName, logger9);
  }
  return logger9;
}
...
async function simulateMultipleInstruction(connection, instructions, keyword, batchRequest = true) {
  const feePayer = new PublicKey2("RaydiumSimuLateTransaction11111111111111111");
  const transactions = [];
...
var SOL_INFO = {
  chainId: 101,
  address: PublicKey3.default.toBase58(),
...
import { PublicKey as PublicKey4, SystemProgram, SYSVAR_RENT_PUBKEY } from "@solana/web3.js";
...
function validateAndParsePublicKey({
  ...
  if (publicKey2 instanceof PublicKey4) {
  ...
  if (typeof publicKey2 === "string") {
    if (publicKey2 === PublicKey4.default.toBase58())
      return PublicKey4.default;
    try {
      const key = new PublicKey4(publicKey2);
      return key;
    } catch {
...
function tryParsePublicKey(v) {
  try {
    return new PublicKey4(v);
  } catch (e) {
    return v;
  }
}
var MEMO_PROGRAM_ID = new PublicKey4("MemoSq4gqABAXKb96qnH8TysNcWxMyWCqXgDLGmfcHr");
var MEMO_PROGRAM_ID2 = new PublicKey4("MemoSq4gqABAXKb96qnH8TysNcWxMyWCqXgDLGmfcHr");
var RENT_PROGRAM_ID = new PublicKey4("SysvarRent111111111111111111111111111111111");
var CLOCK_PROGRAM_ID = new PublicKey4("SysvarC1ock11111111111111111111111111111111");
var METADATA_PROGRAM_ID = new PublicKey4("metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s");
var INSTRUCTION_PROGRAM_ID = new PublicKey4("Sysvar1nstructions1111111111111111111111111");
var SYSTEM_PROGRAM_ID = SystemProgram.programId;
var RAYMint = new PublicKey4("4k3Dyjzvzp8eMZWUXbBCjEvwSkkk59S5iCNLY3QrkX6R");
var PAIMint = new PublicKey4("Ea5SjE2Y6yvCeW5dYTn7PYMuW5ikXkvbGdcmSnXeaLjS");
var SRMMint = new PublicKey4("SRMuApVNdxXokk5GT7XD5cUUgXMBCoAz2LHeuAoKWRt");
var USDCMint = new PublicKey4("EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v");
var USDTMint = new PublicKey4("Es9vMFrzaCERmJfrF4H2FYD4KCoNkY11McCe8BenwNYB");
var mSOLMint = new PublicKey4("mSoLzYCxHdYgdzU16g5QSh3i5K3z3KZK7ytfqcJm7So");
var stSOLMint = new PublicKey4("7dHbWXmci3dT8UFYWYZweBLXgycu7Y3iL6trKn1Y7ARj");
var USDHMint = new PublicKey4("USDH1SM1ojwWUga67PGrgFWUHibbjqMvuMaDkRJTgkX");
var NRVMint = new PublicKey4("NRVwhjBQiUPYtfDT5zRBVJajzFQHaBUNtC7SNVvqRFa");
var ANAMint = new PublicKey4("ANAxByE6G2WjFp7A4NqtWYXb3mgruyzZYg3spfxe6Lbo");
var ETHMint = new PublicKey4("7vfCXTUXx5WJV5JADk17DUJ4ksgau7utNKj4b963voxs");
var WSOLMint = new PublicKey4("So11111111111111111111111111111111111111112");
var SOLMint = PublicKey4.default;
...
var _Token = class {
  ...
  constructor({ mint, decimals, symbol, name, skipMint = false, isToken2022 = false }) {
    if (mint === SOLMint.toBase58() || mint instanceof PublicKey5 && SOLMint.equals(mint)) {
      this.decimals = TOKEN_WSOL.decimals;
      this.symbol = TOKEN_WSOL.symbol;
      this.name = TOKEN_WSOL.name;
      this.mint = new PublicKey5(TOKEN_WSOL.address);
    ...
    this.mint = skipMint ? PublicKey5.default : validateAndParsePublicKey({ publicKey: mint });
...
var _100_PERCENT = new Fraction(new BN5(100));
...
function notInnerObject(v) {
  return typeof v === "object" && v !== null && ![Token, TokenAmount, PublicKey6, Fraction, BN6, Price, Percent].some((o) => typeof o === "object" && v instanceof o);
}
...
// src/common/bignumber.ts
var BN_ZERO = new BN7(0);
var BN_ONE = new BN7(1);
var BN_TWO = new BN7(2);
var BN_THREE = new BN7(3);
var BN_FIVE = new BN7(5);
var BN_TEN = new BN7(10);
var BN_100 = new BN7(100);
var BN_1000 = new BN7(1e3);
var BN_10000 = new BN7(1e4);
...
import { MINT_SIZE, TOKEN_PROGRAM_ID as TOKEN_PROGRAM_ID4, getTransferFeeConfig, unpackMint } from "@solana/spl-token";
...
var FARM_PROGRAM_ID_V3 = new PublicKey9("EhhTKczWMGQt46ynNeRX1WfeagwwJd7ufHvCDjRxjo5Q");
var FARM_PROGRAM_ID_V4 = new PublicKey9("CBuCnLe26faBpcBP2fktp4rp8abpcAnTWft6ZrP5Q4T");
var FARM_PROGRAM_ID_V5 = new PublicKey9("9KEPoZmtHUrBbhWN1v1KWLMkkvwY6WLtAVUCPRtRjP4z");
var FARM_PROGRAM_ID_V6 = new PublicKey9("FarmqiPv5eAj3j1GMdMCMUGXqPUvmquZtMy86QH6rzhG");
var UTIL1216 = new PublicKey9("CLaimxFqjHzgTJtAGHU47NPhg6qrc5sCnpC4tBLyABQS");
var OPEN_BOOK_PROGRAM = new PublicKey9("srmqPvymJeFKQ4zGQed1GFppgkRHL9kaELCbyksJtPX");
var SERUM_PROGRAM_ID_V3 = new PublicKey9("9xQeWvG816bUx9EPjHmaT23yvVM2ZWbrrpZb9PusVFin");
var AMM_V4 = new PublicKey9("675kPX9MHTjS2zt1qfr1NYHuzeLXfQM9H24wFSUt1Mp8");
var AMM_STABLE = new PublicKey9("5quBtoiQqxF9Jv6KYKctB59NT3gtJD2Y65kdnB1Uev3h");
var LIQUIDITY_POOL_PROGRAM_ID_V5_MODEL = new PublicKey9("CDSr3ssLcRB6XYPJwAfFt18MZvEZp4LjHcvzBVZ45duo");
var CLMM_PROGRAM_ID = new PublicKey9("CAMMCzo5YL8w4VFF8KVHrK22GGUsp5VTaW7grrKgrWqK");
var CLMM_LOCK_PROGRAM_ID = new PublicKey9("LockrWmn6K5twhz3y9w1dQERbmgSaRkfnTeTKbpofwE");
var CLMM_LOCK_AUTH_ID = new PublicKey9("kN1kEznaF5Xbd8LYuqtEFcxzWSBk5Fv6ygX6SqEGJVy");
var Router = new PublicKey9("routeUGWgWzqBWFcrCfv8tritsqukccJPu3q5GPP3xS");
var FEE_DESTINATION_ID = new PublicKey9("7YttLkHDoNj9wyDur5pM1ejNaAvT9X4eqaYcHQqtj2G5");
var IDO_PROGRAM_ID_V1 = new PublicKey9("6FJon3QE27qgPVggARueB22hLvoh22VzJpXv4rBEoSLF");
var IDO_PROGRAM_ID_V2 = new PublicKey9("CC12se5To1CdEuw7fDS27B7Geo5jJyL7t5UK2B44NgiH");
var IDO_PROGRAM_ID_V3 = new PublicKey9("9HzJyW1qZsEiSfMUf6L2jo3CcTKAyBmSyKdwQeYisHrC");
var IDO_PROGRAM_ID_V4 = new PublicKey9("DropEU8AvevN3UrXWXTMuz3rqnMczQVNjq3kcSdW2SQi");
var CREATE_CPMM_POOL_PROGRAM = new PublicKey9("CPMMoo8L3F4NbTegBCKVNunggL7H1ZpdTHKxQB5qKP1C");
var CREATE_CPMM_POOL_AUTH = new PublicKey9("GpMZbSM2GgvTKHJirzeGfMFoaZ8UR2X7F4v8vHTvxFbL");
var CREATE_CPMM_POOL_FEE_ACC = new PublicKey9("DNXgeM9EiiaAbaWvwjHj9fQQLAX5ZsfHyvmYUNRAdNC8");
var DEV_CREATE_CPMM_POOL_PROGRAM = new PublicKey9("CPMDWBwJDtYax9qW7AyRuVC19Cc4L4Vcy4n2BHAbHkCW");
var DEV_CREATE_CPMM_POOL_AUTH = new PublicKey9("7rQ1QFNosMkUCuh7Z7fPbTHvh73b68sQYdirycEzJVuw");
var DEV_CREATE_CPMM_POOL_FEE_ACC = new PublicKey9("G11FKBRaAkHAKuLCgLM6K6NUc9rTjPAznRCjZifrTQe2");
var LOCK_CPMM_PROGRAM = new PublicKey9("LockrWmn6K5twhz3y9w1dQERbmgSaRkfnTeTKbpofwE");
var DEV_LOCK_CPMM_PROGRAM = new PublicKey9("DLockwT7X7sxtLmGH9g5kmfcjaBtncdbUmi738m5bvQC");
var LOCK_CPMM_AUTH = new PublicKey9("3f7GcQFG397GAaEnv51zR6tsTVihYRydnydDD1cXekxH");
var DEV_LOCK_CPMM_AUTH = new PublicKey9("7AFUeLVRjBfzqK3tTGw8hN48KLQWSk6DTE8xprWdPqix");
var LAUNCHPAD_PROGRAM = new PublicKey9("LanMV9sAd7wArD4vJFi2qDdfnVhFxYSUg6eADduJ3uj");
var LAUNCHPAD_AUTH = new PublicKey9("WLHv2UAZm6z4KyaaELi5pjdbJh6RESMva1Rnn8pJVVh");
var DEV_LAUNCHPAD_PROGRAM = new PublicKey9("LanD8FpTBBvzZFXjTxsAoipkFsxPUCDB4qAqKxYDiNP");
var DEV_LAUNCHPAD_AUTH = new PublicKey9("HYNHiyKJ3gGVFvyxJAurK7qr7P2o5J9THmvCGMdULtpW");
var DEVNET_PROGRAM_ID = {
  SERUM_MARKET: PublicKey9.default,
  OPENBOOK_MARKET: new PublicKey9("EoTcMgcDRTJVZDMZWBoU6rhYHZfkNTVEAfz3uUJRcYGj"),
  UTIL1216: PublicKey9.default,
  FarmV3: new PublicKey9("85BFyr98MbCUU9MVTEgzx1nbhWACbJqLzho6zd6DZcWL"),
  FarmV5: new PublicKey9("EcLzTrNg9V7qhcdyXDe2qjtPkiGzDM2UbdRaeaadU5r2"),
  FarmV6: new PublicKey9("Farm2hJLcqPtPg8M4rR6DMrsRNc5TPm5Cs4bVQrMe2T7"),
  AmmV4: new PublicKey9("HWy1jotHpo6UqeQxx49dpYYdQB8wj9Qk9MdxwjLvDHB8"),
  AmmStable: new PublicKey9("DDg4VmQaJV9ogWce7LpcjBA9bv22wRp5uaTPa5pGjijF"),
  CLMM: new PublicKey9("devi51mZmdwUJGU9hjN27vEz64Gps7uUefqxg27EAtH"),
  CLMM_LOCK_PROGRAM_ID: new PublicKey9("DLockwT7X7sxtLmGH9g5kmfcjaBtncdbUmi738m5bvQC"),
  CLMM_LOCK_AUTH_ID: new PublicKey9("8qmHNvu2Kr2C7U8mJL4Vz1vTDxMhVuXKREwU7TNoaVEo"),
  Router: new PublicKey9("BVChZ3XFEwTMUk1o9i3HAf91H6mFxSwa5X2wFAWhYPhU"),
  ...
  FEE_DESTINATION_ID: new PublicKey9("3XMrhbv989VxAMi3DErLV9eJht1pHppW5LbKxe9fkEFR"),
...
import { PublicKey as PublicKey10, AddressLookupTableAccount } from "@solana/web3.js";
var LOOKUP_TABLE_CACHE = {
  "AcL1Vo8oy1ULiavEcjSUcwfBSForXMudcZvDZy5nzJkU": new AddressLookupTableAccount({
    key: new PublicKey10("AcL1Vo8oy1ULiavEcjSUcwfBSForXMudcZvDZy5nzJkU"),
...
var TokenAmount = class extends Fraction {
  ...
  constructor(token, amount, isRaw = true, name) {
    let parsedAmount = new BN10(0);
    const multiplier = BN_TEN.pow(new BN10(token.decimals));
    if (isRaw) {
      parsedAmount = parseBigNumberish(amount);
    } else {
      let integralAmount = new BN10(0);
      let fractionalAmount = new BN10(0);
...
import { PublicKey as PublicKey14, SystemProgram as SystemProgram3, SYSVAR_RENT_PUBKEY as SYSVAR_RENT_PUBKEY2, TransactionInstruction as TransactionInstruction3 } from "@solana/web3.js";
import { ASSOCIATED_TOKEN_PROGRAM_ID, TOKEN_PROGRAM_ID as TOKEN_PROGRAM_ID7 } from "@solana/spl-token";

// src/raydium/liquidity/stable.ts
import { PublicKey as PublicKey13 } from "@solana/web3.js";
var MODEL_DATA_PUBKEY = new PublicKey13("CDSr3ssLcRB6XYPJwAfFt18MZvEZp4LjHcvzBVZ45duo");
...
function makeAddLiquidityInstruction(params) {
  ...
  const keys = [
    accountMeta({ pubkey: TOKEN_PROGRAM_ID7, isWritable: false }),
    accountMeta({ pubkey: new PublicKey14(poolInfo.id) }),
    accountMeta({ pubkey: new PublicKey14(poolKeys.authority), isWritable: false }),
    accountMeta({ pubkey: new PublicKey14(poolKeys.openOrders), isWritable: false }),
    accountMeta({ pubkey: new PublicKey14(poolKeys.targetOrders) }),
    accountMeta({ pubkey: new PublicKey14(poolInfo.lpMint.address) }),
    accountMeta({ pubkey: new PublicKey14(poolKeys.vault.A) }),
    accountMeta({ pubkey: new PublicKey14(poolKeys.vault.B) })
  ];
  if (poolInfo.pooltype.includes("StablePool")) {
    keys.push(accountMeta({ pubkey: MODEL_DATA_PUBKEY }));
  }
  keys.push(accountMeta({ pubkey: new PublicKey14(poolInfo.marketId), isWritable: false }), accountMeta({ pubkey: userKeys.baseTokenAccount }), accountMeta({ pubkey: userKeys.quoteTokenAccount }), accountMeta({ pubkey: userKeys.lpTokenAccount }), accountMeta({ pubkey: userKeys.owner, isWritable: false, isSigner: true }), accountMeta({ pubkey: new PublicKey14(poolKeys.marketEventQueue), isWritable: false }));
  return new TransactionInstruction3({
    programId: new PublicKey14(poolInfo.programId),
    keys,
    data
  });
}
function removeLiquidityInstruction(params) {
  ...
  return new TransactionInstruction3({ programId: poolKeys.programId, keys: [] });
}
...
function simulatePoolInfoInstruction(poolKeys) {
  ...
  const keys = [
    accountMeta({ pubkey: new PublicKey14(poolKeys.id), isWritable: false }),
    accountMeta({ pubkey: new PublicKey14(poolKeys.authority), isWritable: false }),
    accountMeta({ pubkey: new PublicKey14(poolKeys.openOrders), isWritable: false }),
    accountMeta({ pubkey: new PublicKey14(poolKeys.vault.A), isWritable: false }),
    accountMeta({ pubkey: new PublicKey14(poolKeys.vault.B), isWritable: false }),
    accountMeta({ pubkey: new PublicKey14(poolKeys.mintLp.address), isWritable: false }),
    accountMeta({ pubkey: new PublicKey14(poolKeys.marketId), isWritable: false }),
    accountMeta({ pubkey: new PublicKey14(poolKeys.marketEventQueue), isWritable: false })
  ];
  return new TransactionInstruction3({
    programId: new PublicKey14(poolKeys.programId),
    keys,
    data
  });
}
...
function getSerumAssociatedAuthority({ programId, marketId }) {
  ...
  while (nonce < 100) {
    try {
      ...
      publicKey2 = PublicKey15.createProgramAddressSync(seedsWithNonce, programId);
    } catch (err) {
...
import { Keypair as Keypair2, PublicKey as PublicKey16 } from "@solana/web3.js";
...
import { PublicKey as PublicKey17, SystemProgram as SystemProgram4 } from "@solana/web3.js";
...
function getAssociatedPoolKeys({
  ...
  return {
    ...
    marketId,
    marketAuthority,
    lookupTableAccount: PublicKey18.default,
  ...
  return await Promise.all(poolKeysList.map(async (itemPoolKey) => {
    if (itemPoolKey.modelDataAccount) {
      ...
      const poolsInfo = logs.map((log3) => {
        ...
        const status = new BN13(parseSimulateValue(json, "status"));
        ...
        const baseReserve = new BN13(parseSimulateValue(json, "pool_coin_amount"));
        const quoteReserve = new BN13(parseSimulateValue(json, "pool_pc_amount"));
        const lpSupply = new BN13(parseSimulateValue(json, "pool_lp_supply"));
        let startTime = "0";
        try {
        ...
        return {
          ...
          quoteReserve,
          lpSupply,
          startTime: new BN13(startTime)
        };
      })[0];
      return poolsInfo;
    } else {
      const [poolAcc, vaultAccA, vaultAccB, mintAccLp] = await connection.getMultipleAccountsInfo([
        new PublicKey18(itemPoolKey.id),
        new PublicKey18(itemPoolKey.vault.A),
        new PublicKey18(itemPoolKey.vault.B),
        new PublicKey18(itemPoolKey.mintLp.address)
      ]);
      if (poolAcc === null)
...
var toAmmComputePoolInfo = (poolData) => {
  const data = {};
  const tokenProgramStr = TOKEN_PROGRAM_ID10.toBase58();
