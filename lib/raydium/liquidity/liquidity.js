...
__export(liquidity_exports, {
  default: () => LiquidityModule
});
module.exports = __toCommonJS(liquidity_exports);
...
function createLogger(moduleName) {
  let logger13 = (0, import_lodash.get)(moduleLoggers, moduleName);
  if (!logger13) {
    const logLevel = (0, import_lodash.get)(moduleLevels, moduleName);
    logger13 = new Logger({ name: moduleName, logLevel });
    (0, import_lodash.set)(moduleLoggers, moduleName, logger13);
  }
  return logger13;
}
...
function validateAndParsePublicKey({
  ...
  if (publicKey2 instanceof import_web32.PublicKey) {
  ...
  if (typeof publicKey2 === "string") {
    if (publicKey2 === import_web32.PublicKey.default.toBase58())
      return import_web32.PublicKey.default;
    try {
      const key = new import_web32.PublicKey(publicKey2);
      return key;
    } catch {
...
function notInnerObject(v) {
  return typeof v === "object" && v !== null && ![Token, TokenAmount, import_web34.PublicKey, Fraction, import_bn5.default, Price, Percent].some((o) => typeof o === "object" && v instanceof o);
}
...
function addComputeBudget(config2) {
  ...
  if (config2.microLamports) {
    ins.push(import_web35.ComputeBudgetProgram.setComputeUnitPrice({ microLamports: config2.microLamports }));
    insTypes.push(InstructionType.SetComputeUnitPrice);
  }
  if (config2.units) {
    ins.push(import_web35.ComputeBudgetProgram.setComputeUnitLimit({ units: config2.units }));
...
function findProgramAddress(seeds, programId) {
  const [publicKey2, nonce] = import_web35.PublicKey.findProgramAddressSync(seeds, programId);
...
function checkV0TxSize({
  ...
  recentBlockhash = import_web35.Keypair.generate().publicKey.toString()
}) {
  const transactionMessage = new import_web35.TransactionMessage({
    payerKey: payer,
    recentBlockhash,
    instructions
  });
  ...
  try {
    const buildLength = Buffer.from(new import_web35.VersionedTransaction(messageV0).serialize()).toString("base64").length;
...
function printSimulate(transactions) {
  ...
  transactions.forEach((transaction) => {
    if (transaction instanceof import_web35.Transaction) {
      if (!transaction.recentBlockhash)
        transaction.recentBlockhash = import_spl_token3.TOKEN_PROGRAM_ID.toBase58();
      if (!transaction.feePayer)
        transaction.feePayer = import_web35.Keypair.generate().publicKey;
    }
...
function getATAAddress(owner, mint, programId) {
  return findProgramAddress([owner.toBuffer(), (programId ?? import_spl_token4.TOKEN_PROGRAM_ID).toBuffer(), mint.toBuffer()], new import_web36.PublicKey("ATokenGPvbdGVxr1b2hvZbsiqW5xWH25efTNsLJA8knL"));
}

// src/common/programId.ts
var import_web37 = require("@solana/web3.js");
var FARM_PROGRAM_ID_V3 = new import_web37.PublicKey("EhhTKczWMGQt46ynNeRX1WfeagwwJd7ufHvCDjRxjo5Q");
var FARM_PROGRAM_ID_V4 = new import_web37.PublicKey("CBuCnLe26faBpcBP2fktp4rp8abpcAnTWft6ZrP5Q4T");
var FARM_PROGRAM_ID_V5 = new import_web37.PublicKey("9KEPoZmtHUrBbhWN1v1KWLMkkvwY6WLtAVUCPRtRjP4z");
var FARM_PROGRAM_ID_V6 = new import_web37.PublicKey("FarmqiPv5eAj3j1GMdMCMUGXqPUvmquZtMy86QH6rzhG");
var UTIL1216 = new import_web37.PublicKey("CLaimxFqjHzgTJtAGHU47NPhg6qrc5sCnpC4tBLyABQS");
var OPEN_BOOK_PROGRAM = new import_web37.PublicKey("srmqPvymJeFKQ4zGQed1GFppgkRHL9kaELCbyksJtPX");
var SERUM_PROGRAM_ID_V3 = new import_web37.PublicKey("9xQeWvG816bUx9EPjHmaT23yvVM2ZWbrrpZb9PusVFin");
var AMM_V4 = new import_web37.PublicKey("675kPX9MHTjS2zt1qfr1NYHuzeLXfQM9H24wFSUt1Mp8");
var AMM_STABLE = new import_web37.PublicKey("5quBtoiQqxF9Jv6KYKctB59NT3gtJD2Y65kdnB1Uev3h");
var LIQUIDITY_POOL_PROGRAM_ID_V5_MODEL = new import_web37.PublicKey("CDSr3ssLcRB6XYPJwAfFt18MZvEZp4LjHcvzBVZ45duo");
var CLMM_PROGRAM_ID = new import_web37.PublicKey("CAMMCzo5YL8w4VFF8KVHrK22GGUsp5VTaW7grrKgrWqK");
var CLMM_LOCK_PROGRAM_ID = new import_web37.PublicKey("LockrWmn6K5twhz3y9w1dQERbmgSaRkfnTeTKbpofwE");
var CLMM_LOCK_AUTH_ID = new import_web37.PublicKey("kN1kEznaF5Xbd8LYuqtEFcxzWSBk5Fv6ygX6SqEGJVy");
var Router = new import_web37.PublicKey("routeUGWgWzqBWFcrCfv8tritsqukccJPu3q5GPP3xS");
var FEE_DESTINATION_ID = new import_web37.PublicKey("7YttLkHDoNj9wyDur5pM1ejNaAvT9X4eqaYcHQqtj2G5");
var IDO_PROGRAM_ID_V1 = new import_web37.PublicKey("6FJon3QE27qgPVggARueB22hLvoh22VzJpXv4rBEoSLF");
var IDO_PROGRAM_ID_V2 = new import_web37.PublicKey("CC12se5To1CdEuw7fDS27B7Geo5jJyL7t5UK2B44NgiH");
var IDO_PROGRAM_ID_V3 = new import_web37.PublicKey("9HzJyW1qZsEiSfMUf6L2jo3CcTKAyBmSyKdwQeYisHrC");
var IDO_PROGRAM_ID_V4 = new import_web37.PublicKey("DropEU8AvevN3UrXWXTMuz3rqnMczQVNjq3kcSdW2SQi");
var CREATE_CPMM_POOL_PROGRAM = new import_web37.PublicKey("CPMMoo8L3F4NbTegBCKVNunggL7H1ZpdTHKxQB5qKP1C");
var CREATE_CPMM_POOL_AUTH = new import_web37.PublicKey("GpMZbSM2GgvTKHJirzeGfMFoaZ8UR2X7F4v8vHTvxFbL");
var CREATE_CPMM_POOL_FEE_ACC = new import_web37.PublicKey("DNXgeM9EiiaAbaWvwjHj9fQQLAX5ZsfHyvmYUNRAdNC8");
var DEV_CREATE_CPMM_POOL_PROGRAM = new import_web37.PublicKey("CPMDWBwJDtYax9qW7AyRuVC19Cc4L4Vcy4n2BHAbHkCW");
var DEV_CREATE_CPMM_POOL_AUTH = new import_web37.PublicKey("7rQ1QFNosMkUCuh7Z7fPbTHvh73b68sQYdirycEzJVuw");
var DEV_CREATE_CPMM_POOL_FEE_ACC = new import_web37.PublicKey("G11FKBRaAkHAKuLCgLM6K6NUc9rTjPAznRCjZifrTQe2");
var LOCK_CPMM_PROGRAM = new import_web37.PublicKey("LockrWmn6K5twhz3y9w1dQERbmgSaRkfnTeTKbpofwE");
var DEV_LOCK_CPMM_PROGRAM = new import_web37.PublicKey("DLockwT7X7sxtLmGH9g5kmfcjaBtncdbUmi738m5bvQC");
var LOCK_CPMM_AUTH = new import_web37.PublicKey("3f7GcQFG397GAaEnv51zR6tsTVihYRydnydDD1cXekxH");
var DEV_LOCK_CPMM_AUTH = new import_web37.PublicKey("7AFUeLVRjBfzqK3tTGw8hN48KLQWSk6DTE8xprWdPqix");
var LAUNCHPAD_PROGRAM = new import_web37.PublicKey("LanMV9sAd7wArD4vJFi2qDdfnVhFxYSUg6eADduJ3uj");
var LAUNCHPAD_AUTH = new import_web37.PublicKey("WLHv2UAZm6z4KyaaELi5pjdbJh6RESMva1Rnn8pJVVh");
var DEV_LAUNCHPAD_PROGRAM = new import_web37.PublicKey("LanD8FpTBBvzZFXjTxsAoipkFsxPUCDB4qAqKxYDiNP");
var DEV_LAUNCHPAD_AUTH = new import_web37.PublicKey("HYNHiyKJ3gGVFvyxJAurK7qr7P2o5J9THmvCGMdULtpW");
var DEVNET_PROGRAM_ID = {
  SERUM_MARKET: import_web37.PublicKey.default,
  OPENBOOK_MARKET: new import_web37.PublicKey("EoTcMgcDRTJVZDMZWBoU6rhYHZfkNTVEAfz3uUJRcYGj"),
  UTIL1216: import_web37.PublicKey.default,
  FarmV3: new import_web37.PublicKey("85BFyr98MbCUU9MVTEgzx1nbhWACbJqLzho6zd6DZcWL"),
  FarmV5: new import_web37.PublicKey("EcLzTrNg9V7qhcdyXDe2qjtPkiGzDM2UbdRaeaadU5r2"),
  FarmV6: new import_web37.PublicKey("Farm2hJLcqPtPg8M4rR6DMrsRNc5TPm5Cs4bVQrMe2T7"),
  AmmV4: new import_web37.PublicKey("HWy1jotHpo6UqeQxx49dpYYdQB8wj9Qk9MdxwjLvDHB8"),
  AmmStable: new import_web37.PublicKey("DDg4VmQaJV9ogWce7LpcjBA9bv22wRp5uaTPa5pGjijF"),
  CLMM: new import_web37.PublicKey("devi51mZmdwUJGU9hjN27vEz64Gps7uUefqxg27EAtH"),
  CLMM_LOCK_PROGRAM_ID: new import_web37.PublicKey("DLockwT7X7sxtLmGH9g5kmfcjaBtncdbUmi738m5bvQC"),
  CLMM_LOCK_AUTH_ID: new import_web37.PublicKey("8qmHNvu2Kr2C7U8mJL4Vz1vTDxMhVuXKREwU7TNoaVEo"),
  Router: new import_web37.PublicKey("BVChZ3XFEwTMUk1o9i3HAf91H6mFxSwa5X2wFAWhYPhU"),
  ...
  FEE_DESTINATION_ID: new import_web37.PublicKey("3XMrhbv989VxAMi3DErLV9eJht1pHppW5LbKxe9fkEFR"),
...
async function getMultipleLookupTableInfo({
  ...
  const dataInfos = await getMultipleAccountsInfo(connection, [...new Set(address.map((i) => i.toString()))].map((i) => new import_web38.PublicKey(i)));
  const outDict = {};
  for (let i = 0; i < address.length; i++) {
    ...
    if (!info)
      continue;
    const lookupAccount = new import_web38.AddressLookupTableAccount({
      key,
...
var TxBuilder = class {
  ...
  addTipInstruction(tipConfig) {
    if (tipConfig) {
      this.endInstructions.push(import_web39.SystemProgram.transfer({
        fromPubkey: tipConfig.feePayer ?? this.feePayer,
        toPubkey: new import_web39.PublicKey(tipConfig.address),
  ...
  addInstruction({
    ...
    this.lookupTableAddress.push(...lookupTableAddress.filter((address) => address !== import_web39.PublicKey.default.toString()));
    return this;
  }
  async versionBuild({
    txVersion,
    ...
    return {
      ...
      execute: async (params) => {
        ...
        if (this.owner?.isKeyPair) {
          const txId = sendAndConfirm ? await (0, import_web39.sendAndConfirmTransaction)(this.connection, transaction, this.signers.find((s) => s.publicKey.equals(this.owner.publicKey)) ? this.signers : [...this.signers, this.owner.signer], { skipPreflight }) : await this.connection.sendRawTransaction(transaction.serialize(), { skipPreflight });
          return {
            txId,
        ...
        if (this.owner?.isKeyPair) {
          if (sequentially) {
            ...
            for (const tx of allTransactions) {
              ...
              if (i <= skipTxCount)
                continue;
              const txId = await (0, import_web39.sendAndConfirmTransaction)(this.connection, tx, this.signers.find((s) => s.publicKey.equals(this.owner.publicKey)) ? this.signers : [...this.signers, this.owner.signer], { skipPreflight });
              txIds.push(txId);
            }
            return {
              txIds,
  ...
  async buildV0(props, nonce) {
    ...
    for (const item of allLTA) {
      if (lookupTableAddressAccount[item] === void 0)
        needCacheLTA.push(new import_web39.PublicKey(item));
    }
    ...
    const recentBlockhash = nonce ?? (forerunCreate ? import_web39.PublicKey.default.toBase58() : propRecentBlockhash ?? await getRecentBlockHash(this.connection, this.blockhashCommitment));
    ...
    if (this.owner?.signer && !this.signers.some((s) => s.publicKey.equals(this.owner.publicKey)))
      this.signers.push(this.owner.signer);
    const transaction = new import_web39.VersionedTransaction(messageV0);
    transaction.sign(this.signers);
    return {
      builder: this,
      transaction,
  ...
  async sizeCheckBuild(props) {
    ...
    this.allInstructions.forEach((item) => {
      ...
      const _signer = [..._signerStrs.values()].map((i) => new import_web39.PublicKey(i));
      if (item !== splitIns[splitInsIdx] && instructionQueue.length < 12 && (checkLegacyTxSize({ instructions: _itemInsWithCompute, payer: this.feePayer, signers: _signer }) || checkLegacyTxSize({ instructions: _itemIns, payer: this.feePayer, signers: _signer }))) {
        ...
        if (checkLegacyTxSize({
          ...
          allTransactions.push(new import_web39.Transaction().add(...computeBudgetData.instructions, ...instructionQueue));
        } else {
          allTransactions.push(new import_web39.Transaction().add(...instructionQueue));
        }
    ...
    this.allInstructions.forEach((item) => {
      ...
      if (item !== splitIns[splitInsIdx] && instructionQueue.length < 12 && (checkV0TxSize({ instructions: _itemInsWithCompute, payer: this.feePayer, lookupTableAddressAccount }) || checkV0TxSize({ instructions: _itemIns, payer: this.feePayer, lookupTableAddressAccount }))) {
        ...
        if (computeBudgetConfig && checkV0TxSize({
          ...
          allTransactions.push(new import_web39.VersionedTransaction(messageV0));
        } else {
          const messageV0 = new import_web39.TransactionMessage({
            payerKey: this.feePayer,
            recentBlockhash: blockHash,
      ...
      return unsafeRes.result.value.map((accountInfo) => {
        if (accountInfo) {
          ...
          return {
            ...
            executable,
            lamports,
            owner: new import_web310.PublicKey(owner),
            rentEpoch
          };
        }
        return null;
...
var FARM_LOCK_MINT = new import_web312.PublicKey("4k3Dyjzvzp8eMZWUXbBCjEvwSkkk59S5iCNLY3QrkX6R");
var FARM_LOCK_VAULT = new import_web312.PublicKey("FrspKwj8i3pNmKwXreTveC4fu7KL5ZbGeXdZBe2XViu1");
...
function createAssociatedLedgerAccountInstruction(params) {
  ...
  const keys = [
    ...
    accountMeta({ pubkey: import_web313.SystemProgram.programId, isWritable: false }),
    accountMeta({ pubkey: import_web313.SYSVAR_RENT_PUBKEY, isWritable: false })
  ];
  return {
    instruction: new import_web313.TransactionInstruction({
      programId,
      keys,
      data
    }),
...
function makeWithdrawInstructionV6(params) {
  ...
  const [programId, id] = [new import_web313.PublicKey(farmInfo.programId), new import_web313.PublicKey(farmInfo.id)];
  ...
  const keys = [
    accountMeta({ pubkey: import_spl_token6.TOKEN_PROGRAM_ID, isWritable: false }),
    accountMeta({ pubkey: id }),
    accountMeta({ pubkey: new import_web313.PublicKey(farmKeys.authority), isWritable: false }),
    accountMeta({ pubkey: new import_web313.PublicKey(farmKeys.lpVault) }),
  ...
  for (let index = 0; index < farmKeys.rewardInfos.length; index++) {
    keys.push(accountMeta({ pubkey: new import_web313.PublicKey(farmKeys.rewardInfos[index].vault) }));
    keys.push(accountMeta({ pubkey: rewardAccounts[index] }));
  }
  return new import_web313.TransactionInstruction({ programId, keys, data });
}
function makeWithdrawInstructionV5(params) {
  ...
  const keys = [
    ...
    accountMeta({ pubkey: new import_web313.PublicKey(farmKeys.rewardInfos[0].vault) }),
    accountMeta({ pubkey: import_web313.SYSVAR_CLOCK_PUBKEY, isWritable: false }),
    accountMeta({ pubkey: import_spl_token6.TOKEN_PROGRAM_ID, isWritable: false })
  ];
...
var ZERO = new import_bn12.default(0);
var ONE = new import_bn12.default(1);
var NEGATIVE_ONE = new import_bn12.default(-1);
var Q64 = new import_bn12.default(1).shln(64);
var Q128 = new import_bn12.default(1).shln(128);
var MaxU64 = Q64.sub(ONE);
var U64Resolution = 64;
var MaxUint128 = Q128.subn(1);
var MIN_TICK = -443636;
var MAX_TICK = -MIN_TICK;
var MIN_SQRT_PRICE_X64 = new import_bn12.default("4295048016");
var MAX_SQRT_PRICE_X64 = new import_bn12.default("79226673521066979257578248091");
var MIN_SQRT_PRICE_X64_ADD_ONE = new import_bn12.default("4295048017");
var MAX_SQRT_PRICE_X64_SUB_ONE = new import_bn12.default("79226673521066979257578248090");
...
var FEE_RATE_DENOMINATOR = new import_bn12.default(10).pow(new import_bn12.default(6));
var U64_IGNORE_RANGE = new import_bn12.default("18446744073700000000");
...
var PositionUtils = class {
  static getfeeGrowthInside(poolState, tickLowerState, tickUpperState) {
    let feeGrowthBelowX64A = new import_bn13.default(0);
    let feeGrowthBelowX64B = new import_bn13.default(0);
    ...
    let feeGrowthAboveX64A = new import_bn13.default(0);
    let feeGrowthAboveX64B = new import_bn13.default(0);
  ...
  static getRewardGrowthInside(tickCurrentIndex, tickLowerState, tickUpperState, rewardInfos) {
    ...
    for (let i = 0; i < rewardInfos.length; i++) {
      let rewardGrowthsBelow = new import_bn13.default(0);
      ...
      let rewardGrowthsAbove = new import_bn13.default(0);
  ...
  static getAmountsFromLiquidity({
    ...
    const [amountSlippageA, amountSlippageB] = [
      getTransferAmountFeeV2(new import_bn13.default(new decimal_default(amounts.amountA.toString()).mul(coefficientRe).toFixed(0)), poolInfo.mintA.extensions?.feeConfig, epochInfo, true),
      getTransferAmountFeeV2(new import_bn13.default(new decimal_default(amounts.amountB.toString()).mul(coefficientRe).toFixed(0)), poolInfo.mintB.extensions?.feeConfig, epochInfo, true)
    ];
    return {
      liquidity,
      amountA,
...
var PoolUtils = class {
  ...
  static async updatePoolRewardInfos({
    ...
    for (let i = 0; i < rewardInfos.length; i++) {
      ...
      const itemReward = {
        ...
        tokenProgramId: new import_web314.PublicKey(apiRewardProgram)
      };
      if (itemReward.tokenMint.equals(import_web314.PublicKey.default))
        continue;
      if (chainTime <= itemReward.openTime.toNumber() || poolLiquidity.eq(ZERO)) {
        nRewardInfo.push(itemReward);
        continue;
      }
      const latestUpdateTime = new import_bn14.default(Math.min(itemReward.endTime.toNumber(), chainTime));
        ...
        poolInfoA.positionAccount = [
          ...poolInfoA.positionAccount ?? [],
          {
            ...
            rewardInfos: position.rewardInfos.map((i) => ({
              ...i,
              pendingReward: new import_bn14.default(0)
            })),
            leverage,
            tokenFeeAmountA: new import_bn14.default(0),
            tokenFeeAmountB: new import_bn14.default(0)
          }
        ];
      ...
      if (updateOwnerRewardAndFee) {
        ...
        for (const { state, positionAccount } of pools) {
          ...
          for (const itemPA of positionAccount) {
            ...
            itemPA.tokenFeeAmountA = tokenFeeAmountA.gte(new import_bn14.default(0)) ? tokenFeeAmountA : new import_bn14.default(0);
            itemPA.tokenFeeAmountB = tokenFeeAmountB.gte(new import_bn14.default(0)) ? tokenFeeAmountB : new import_bn14.default(0);
            for (let i = 0; i < rewardInfos.length; i++) {
              itemPA.rewardInfos[i].pendingReward = rewardInfos[i].gte(new import_bn14.default(0)) ? rewardInfos[i] : new import_bn14.default(0);
            }
          }
        }
      }
  ...
  static computeAmountOut({
    ...
    if (priceLimit.equals(new decimal_default(0))) {
      sqrtPriceLimitX64 = isBaseIn ? MIN_SQRT_PRICE_X64.add(new import_bn14.default(1)) : MAX_SQRT_PRICE_X64.sub(new import_bn14.default(1));
    } else {
    ...
    const _minAmountOut = _expectedAmountOut.mul(new import_bn14.default(Math.floor((1 - slippage) * 1e10))).div(new import_bn14.default(1e10));
  ...
  static computeAmountOutFormat({
    ...
    const {
      ...
      poolInfo,
      tickArrayCache,
      baseMint: new import_web314.PublicKey(inputMint.address),
      amountIn,
      slippage,
      epochInfo,
    ...
    const _currentPrice = new Price({
      baseToken,
      denominator: new import_bn14.default(10).pow(new import_bn14.default(20 + baseToken.decimals)),
      quoteToken: outToken,
  ...
  static computeAmountIn({
    ...
    const _executionPrice = SqrtPriceMath.sqrtPriceX64ToPrice(_executionPriceX64, poolInfo.mintA.decimals, poolInfo.mintB.decimals);
    const executionPrice = isBaseIn ? _executionPrice : new decimal_default(1).div(_executionPrice);
    const _maxAmountIn = _expectedAmountIn.mul(new import_bn14.default(Math.floor((1 + slippage) * 1e10))).div(new import_bn14.default(1e10));
  ...
  static async getLiquidityAmountOutFromAmountIn({
    ...
    const _amount = new import_bn14.default(new decimal_default(addFeeAmount.amount.sub(addFeeAmount.fee ?? ZERO).toString()).toFixed(0));
    let liquidity;
    if (sqrtPriceX64.lte(sqrtPriceX64A)) {
      liquidity = inputA ? LiquidityMath.getLiquidityFromTokenAmountA(sqrtPriceX64A, sqrtPriceX64B, _amount, !add2) : new import_bn14.default(0);
      ...
      liquidity = inputA ? new import_bn14.default(0) : LiquidityMath.getLiquidityFromTokenAmountB(sqrtPriceX64A, sqrtPriceX64B, _amount);
    }
  ...
  static async fetchComputeMultipleClmmInfo({
    ...
    const fetchRpcList = poolList.filter((p) => !rpcDataMap[p.id]).map((p) => new import_web314.PublicKey(p.id));
    ...
    const pdaList = poolList.map((poolInfo) => getPdaExBitmapAccount(new import_web314.PublicKey(poolInfo.programId), new import_web314.PublicKey(poolInfo.id)).publicKey);
    ...
    return poolList.reduce((acc, cur) => ({
      ...
      [cur.id]: {
        ...rpcDataMap[cur.id],
        id: new import_web314.PublicKey(cur.id),
        version: 6,
        programId: new import_web314.PublicKey(cur.programId),
        mintA: cur.mintA,
        mintB: cur.mintB,
        ammConfig: {
          ...cur.config,
          id: new import_web314.PublicKey(cur.config.id),
          fundOwner: ""
        },
        currentPrice: new decimal_default(cur.price),
        exBitmapAccount: getPdaExBitmapAccount(new import_web314.PublicKey(cur.programId), new import_web314.PublicKey(cur.id)).publicKey,
        exBitmapInfo: exBitData[getPdaExBitmapAccount(new import_web314.PublicKey(cur.programId), new import_web314.PublicKey(cur.id)).publicKey.toBase58()],
...
var MathUtil = class {
  ...
  static decimalToX64(num) {
    return new import_bn15.default(num.mul(decimal_default.pow(2, 64)).floor().toFixed());
  }
...
var SqrtPriceMath = class {
  ...
  static getSqrtPriceX64FromTick(tick) {
    ...
    let ratio = (tickAbs & 1) != 0 ? new import_bn15.default("18445821805675395072") : new import_bn15.default("18446744073709551616");
    if ((tickAbs & 2) != 0)
      ratio = mulRightShift(ratio, new import_bn15.default("18444899583751176192"));
    if ((tickAbs & 4) != 0)
      ratio = mulRightShift(ratio, new import_bn15.default("18443055278223355904"));
    if ((tickAbs & 8) != 0)
      ratio = mulRightShift(ratio, new import_bn15.default("18439367220385607680"));
    if ((tickAbs & 16) != 0)
      ratio = mulRightShift(ratio, new import_bn15.default("18431993317065453568"));
    if ((tickAbs & 32) != 0)
      ratio = mulRightShift(ratio, new import_bn15.default("18417254355718170624"));
    if ((tickAbs & 64) != 0)
      ratio = mulRightShift(ratio, new import_bn15.default("18387811781193609216"));
    if ((tickAbs & 128) != 0)
      ratio = mulRightShift(ratio, new import_bn15.default("18329067761203558400"));
    if ((tickAbs & 256) != 0)
      ratio = mulRightShift(ratio, new import_bn15.default("18212142134806163456"));
    if ((tickAbs & 512) != 0)
      ratio = mulRightShift(ratio, new import_bn15.default("17980523815641700352"));
    if ((tickAbs & 1024) != 0)
      ratio = mulRightShift(ratio, new import_bn15.default("17526086738831433728"));
    if ((tickAbs & 2048) != 0)
      ratio = mulRightShift(ratio, new import_bn15.default("16651378430235570176"));
    if ((tickAbs & 4096) != 0)
      ratio = mulRightShift(ratio, new import_bn15.default("15030750278694412288"));
    if ((tickAbs & 8192) != 0)
      ratio = mulRightShift(ratio, new import_bn15.default("12247334978884435968"));
    if ((tickAbs & 16384) != 0)
      ratio = mulRightShift(ratio, new import_bn15.default("8131365268886854656"));
    if ((tickAbs & 32768) != 0)
      ratio = mulRightShift(ratio, new import_bn15.default("3584323654725218816"));
    if ((tickAbs & 65536) != 0)
      ratio = mulRightShift(ratio, new import_bn15.default("696457651848324352"));
    if ((tickAbs & 131072) != 0)
      ratio = mulRightShift(ratio, new import_bn15.default("26294789957507116"));
    if ((tickAbs & 262144) != 0)
      ratio = mulRightShift(ratio, new import_bn15.default("37481735321082"));
    if (tick > 0)
  ...
  static getTickFromSqrtPriceX64(sqrtPriceX64) {
    ...
    const adjustedMsb = new import_bn15.default(msb - 64);
    const log2pIntegerX32 = signedLeftShift(adjustedMsb, 32, 128);
    let bit = new import_bn15.default("8000000000000000", "hex");
    let precision = 0;
    let log2pFractionX64 = new import_bn15.default(0);
    let r = msb >= 64 ? sqrtPriceX64.shrn(msb - 63) : sqrtPriceX64.shln(63 - msb);
    while (bit.gt(new import_bn15.default(0)) && precision < BIT_PRECISION) {
      r = r.mul(r);
    ...
    const logbpX64 = log2pX32.mul(new import_bn15.default(LOG_B_2_X32));
    const tickLow = signedRightShift(logbpX64.sub(new import_bn15.default(LOG_B_P_ERR_MARGIN_LOWER_X64)), 64, 128).toNumber();
    const tickHigh = signedRightShift(logbpX64.add(new import_bn15.default(LOG_B_P_ERR_MARGIN_UPPER_X64)), 64, 128).toNumber();
    if (tickLow == tickHigh) {
      return tickLow;
    } else {
...
var LiquidityMath = class {
  ...
  static getAmountsFromLiquidity(sqrtPriceCurrentX64, sqrtPriceX64A, sqrtPriceX64B, liquidity, roundUp) {
    ...
    if (sqrtPriceCurrentX64.lte(sqrtPriceX64A)) {
      return {
        ...
        amountB: new import_bn15.default(0)
      };
    } else if (sqrtPriceCurrentX64.lt(sqrtPriceX64B)) {
      ...
      return {
        amountA: new import_bn15.default(0),
  ...
  static getAmountsFromLiquidityWithSlippage(sqrtPriceCurrentX64, sqrtPriceX64A, sqrtPriceX64B, liquidity, amountMax, roundUp, amountSlippage) {
    ...
    const amount0Slippage = new import_bn15.default(new decimal_default(amountA.toString()).mul(coefficient).toFixed(0));
    const amount1Slippage = new import_bn15.default(new decimal_default(amountB.toString()).mul(coefficient).toFixed(0));
    return {
  ...
  static getAmountsOutFromLiquidity({
    ...
    const [amountSlippageA, amountSlippageB] = [
      getTransferAmountFeeV2(new import_bn15.default(new decimal_default(amounts.amountA.toString()).mul(coefficientRe).toFixed(0)), poolInfo.mintA.extensions?.feeConfig, epochInfo, amountAddFee),
      getTransferAmountFeeV2(new import_bn15.default(new decimal_default(amounts.amountB.toString()).mul(coefficientRe).toFixed(0)), poolInfo.mintB.extensions?.feeConfig, epochInfo, amountAddFee)
    ];
    return {
      liquidity,
      amountA,
...
var SwapMath = class {
  static swapCompute(programId, poolId, tickArrayCache, tickArrayBitmap, tickarrayBitmapExtension, zeroForOne, fee, liquidity, currentTick, tickSpacing, currentSqrtPriceX64, amountSpecified, lastSavedTickArrayStartIndex, sqrtPriceLimitX64, catchLiquidityInsufficient = false) {
    ...
    const state = {
      ...
      accounts: [],
      liquidity,
      feeAmount: new import_bn15.default(0)
    };
  ...
  static swapStepCompute(sqrtPriceX64Current, sqrtPriceX64Target, liquidity, amountRemaining, feeRate, zeroForOne) {
    const swapStep = {
      sqrtPriceX64Next: new import_bn15.default(0),
      amountIn: new import_bn15.default(0),
      amountOut: new import_bn15.default(0),
      feeAmount: new import_bn15.default(0)
    };
    const baseInput = amountRemaining.gte(ZERO);
    if (baseInput) {
      const amountRemainingSubtractFee = MathUtil.mulDivFloor(amountRemaining, FEE_RATE_DENOMINATOR.sub(new import_bn15.default(feeRate.toString())), FEE_RATE_DENOMINATOR);
    ...
    if (baseInput && !swapStep.sqrtPriceX64Next.eq(sqrtPriceX64Target)) {
      ...
      swapStep.feeAmount = MathUtil.mulDivCeil(swapStep.amountIn, new import_bn15.default(feeRate), FEE_RATE_DENOMINATOR.sub(new import_bn15.default(feeRate)));
    }
...
var TickUtils = class {
  ...
  static mergeTickArrayBitmap(bns) {
    let b = new import_bn16.default(0);
...
var ClmmInstrument = class {
  static createPoolInstruction(programId, poolId, poolCreator, ammConfigId, observationId, mintA, mintVaultA, mintProgramIdA, mintB, mintVaultB, mintProgramIdB, exTickArrayBitmap, sqrtPriceX64, extendMintAccount) {
    ...
    return new import_web315.TransactionInstruction({
      keys,
      programId,
      data: aData
    });
  ...
  static async createPoolInstructions(props) {
    ...
    const [mintAAddress, mintBAddress] = [new import_web315.PublicKey(mintA.address), new import_web315.PublicKey(mintB.address)];
    ...
    const ins = [
      this.createPoolInstruction(programId, poolId, owner, ammConfigId, observationId, mintAAddress, mintAVault, new import_web315.PublicKey(mintA.programId || import_spl_token8.TOKEN_PROGRAM_ID), mintBAddress, mintBVault, new import_web315.PublicKey(mintB.programId || import_spl_token8.TOKEN_PROGRAM_ID), exBitmapAccount, initialPriceX64, extendMintAccount)
    ];
    return {
      signers: [],
      instructions: ins,
  ...
  static async openPositionInstructions({
    ...
    const signers = [];
    const [programId, id] = [new import_web315.PublicKey(poolInfo.programId), new import_web315.PublicKey(poolInfo.id)];
    let nftMintAccount;
    if (getEphemeralSigners) {
      nftMintAccount = new import_web315.PublicKey((await getEphemeralSigners(1))[0]);
    } else {
      const _k = import_web315.Keypair.generate();
      signers.push(_k);
    ...
    const ins = nft2022 ? this.openPositionFromLiquidityInstruction22(programId, ownerInfo.feePayer, id, ownerInfo.wallet, nftMintAccount, positionNftAccount, protocolPosition, tickArrayLower, tickArrayUpper, personalPosition, ownerInfo.tokenAccountA, ownerInfo.tokenAccountB, new import_web315.PublicKey(poolKeys.vault.A), new import_web315.PublicKey(poolKeys.vault.B), new import_web315.PublicKey(poolInfo.mintA.address), new import_web315.PublicKey(poolInfo.mintB.address), tickLower, tickUpper, tickArrayLowerStartIndex, tickArrayUpperStartIndex, liquidity, amountMaxA, amountMaxB, withMetadata, PoolUtils.isOverflowDefaultTickarrayBitmap(poolInfo.config.tickSpacing, [
      tickArrayLowerStartIndex,
      tickArrayUpperStartIndex
    ]) ? getPdaExBitmapAccount(programId, id).publicKey : void 0) : this.openPositionFromLiquidityInstruction(programId, ownerInfo.feePayer, id, ownerInfo.wallet, nftMintAccount, positionNftAccount, metadataAccount, protocolPosition, tickArrayLower, tickArrayUpper, personalPosition, ownerInfo.tokenAccountA, ownerInfo.tokenAccountB, new import_web315.PublicKey(poolKeys.vault.A), new import_web315.PublicKey(poolKeys.vault.B), new import_web315.PublicKey(poolInfo.mintA.address), new import_web315.PublicKey(poolInfo.mintB.address), tickLower, tickUpper, tickArrayLowerStartIndex, tickArrayUpperStartIndex, liquidity, amountMaxA, amountMaxB, withMetadata, PoolUtils.isOverflowDefaultTickarrayBitmap(poolInfo.config.tickSpacing, [
      tickArrayLowerStartIndex,
      tickArrayUpperStartIndex
  ...
  static async openPositionFromBaseInstructions({
    ...
    const { publicKey: personalPosition } = getPdaPersonalPositionAddress(programId, nftMintAccount);
    const { publicKey: protocolPosition } = getPdaProtocolPositionAddress(programId, id, tickLower, tickUpper);
    const ins = nft2022 ? this.openPositionFromBaseInstruction22(programId, ownerInfo.feePayer, id, ownerInfo.wallet, nftMintAccount, positionNftAccount, protocolPosition, tickArrayLower, tickArrayUpper, personalPosition, ownerInfo.tokenAccountA, ownerInfo.tokenAccountB, new import_web315.PublicKey(poolKeys.vault.A), new import_web315.PublicKey(poolKeys.vault.B), new import_web315.PublicKey(poolInfo.mintA.address), new import_web315.PublicKey(poolInfo.mintB.address), tickLower, tickUpper, tickArrayLowerStartIndex, tickArrayUpperStartIndex, withMetadata, base, baseAmount, otherAmountMax, PoolUtils.isOverflowDefaultTickarrayBitmap(poolInfo.config.tickSpacing, [
      tickArrayLowerStartIndex,
      tickArrayUpperStartIndex
    ]) ? getPdaExBitmapAccount(programId, id).publicKey : void 0) : this.openPositionFromBaseInstruction(programId, ownerInfo.feePayer, id, ownerInfo.wallet, nftMintAccount, positionNftAccount, metadataAccount, protocolPosition, tickArrayLower, tickArrayUpper, personalPosition, ownerInfo.tokenAccountA, ownerInfo.tokenAccountB, new import_web315.PublicKey(poolKeys.vault.A), new import_web315.PublicKey(poolKeys.vault.B), new import_web315.PublicKey(poolInfo.mintA.address), new import_web315.PublicKey(poolInfo.mintB.address), tickLower, tickUpper, tickArrayLowerStartIndex, tickArrayUpperStartIndex, withMetadata, base, baseAmount, otherAmountMax, PoolUtils.isOverflowDefaultTickarrayBitmap(poolInfo.config.tickSpacing, [
      tickArrayLowerStartIndex,
      tickArrayUpperStartIndex
    ]) ? getPdaExBitmapAccount(programId, id).publicKey : void 0);
    return {
  ...
  static openPositionFromBaseInstruction(programId, payer, poolId, positionNftOwner, positionNftMint, positionNftAccount, metadataAccount, protocolPosition, tickArrayLower, tickArrayUpper, personalPosition, ownerTokenAccountA, ownerTokenAccountB, tokenVaultA, tokenVaultB, tokenMintA, tokenMintB, tickLowerIndex, tickUpperIndex, tickArrayLowerStartIndex, tickArrayUpperStartIndex, withMetadata, base, baseAmount, otherAmountMax, exTickArrayBitmap) {
    ...
    dataLayout.encode({
      ...
      tickArrayLowerStartIndex,
      tickArrayUpperStartIndex,
      liquidity: new import_bn17.default(0),
  ...
  static async openPositionFromLiquidityInstructions({
    ...
    const { publicKey: personalPosition } = getPdaPersonalPositionAddress(programId, nftMintAccount);
    const { publicKey: protocolPosition } = getPdaProtocolPositionAddress(programId, id, tickLower, tickUpper);
    const ins = nft2022 ? this.openPositionFromLiquidityInstruction22(programId, ownerInfo.wallet, id, ownerInfo.wallet, nftMintAccount, positionNftAccount, protocolPosition, tickArrayLower, tickArrayUpper, personalPosition, ownerInfo.tokenAccountA, ownerInfo.tokenAccountB, new import_web315.PublicKey(poolKeys.vault.A), new import_web315.PublicKey(poolKeys.vault.B), new import_web315.PublicKey(poolKeys.mintA.address), new import_web315.PublicKey(poolKeys.mintB.address), tickLower, tickUpper, tickArrayLowerStartIndex, tickArrayUpperStartIndex, liquidity, amountMaxA, amountMaxB, withMetadata, PoolUtils.isOverflowDefaultTickarrayBitmap(poolInfo.config.tickSpacing, [
      tickArrayLowerStartIndex,
      tickArrayUpperStartIndex
    ]) ? getPdaExBitmapAccount(programId, id).publicKey : void 0) : this.openPositionFromLiquidityInstruction(programId, ownerInfo.wallet, id, ownerInfo.wallet, nftMintAccount, positionNftAccount, metadataAccount, protocolPosition, tickArrayLower, tickArrayUpper, personalPosition, ownerInfo.tokenAccountA, ownerInfo.tokenAccountB, new import_web315.PublicKey(poolKeys.vault.A), new import_web315.PublicKey(poolKeys.vault.B), new import_web315.PublicKey(poolKeys.mintA.address), new import_web315.PublicKey(poolKeys.mintB.address), tickLower, tickUpper, tickArrayLowerStartIndex, tickArrayUpperStartIndex, liquidity, amountMaxA, amountMaxB, withMetadata, PoolUtils.isOverflowDefaultTickarrayBitmap(poolInfo.config.tickSpacing, [
      tickArrayLowerStartIndex,
      tickArrayUpperStartIndex
    ]) ? getPdaExBitmapAccount(programId, id).publicKey : void 0);
    return {
  ...
  static closePositionInstructions({
    ...
    const programId = new import_web315.PublicKey(poolInfo.programId);
  ...
  static increasePositionFromLiquidityInstructions({
    ...
    const ins = this.increasePositionFromLiquidityInstruction(programId, ownerInfo.wallet, positionNftAccount, personalPosition, id, protocolPosition, tickArrayLower, tickArrayUpper, ownerInfo.tokenAccountA, ownerInfo.tokenAccountB, new import_web315.PublicKey(poolKeys.vault.A), new import_web315.PublicKey(poolKeys.vault.B), new import_web315.PublicKey(poolInfo.mintA.address), new import_web315.PublicKey(poolInfo.mintB.address), liquidity, amountMaxA, amountMaxB, PoolUtils.isOverflowDefaultTickarrayBitmap(poolInfo.config.tickSpacing, [
      tickArrayLowerStartIndex,
      tickArrayUpperStartIndex
    ]) ? getPdaExBitmapAccount(programId, id).publicKey : void 0);
    return {
  ...
  static increasePositionFromBaseInstructions({
    ...
    return {
      ...
      instructions: [
        this.increasePositionFromBaseInstruction(programId, ownerInfo.wallet, positionNftAccount, personalPosition, id, protocolPosition, tickArrayLower, tickArrayUpper, ownerInfo.tokenAccountA, ownerInfo.tokenAccountB, new import_web315.PublicKey(poolKeys.vault.A), new import_web315.PublicKey(poolKeys.vault.B), new import_web315.PublicKey(poolInfo.mintA.address), new import_web315.PublicKey(poolInfo.mintB.address), base, baseAmount, otherAmountMax, PoolUtils.isOverflowDefaultTickarrayBitmap(poolInfo.config.tickSpacing, [
          tickArrayLowerStartIndex,
          tickArrayUpperStartIndex
        ]) ? getPdaExBitmapAccount(programId, id).publicKey : void 0)
      ],
  ...
  static decreaseLiquidityInstructions({
    ...
    const [poolProgramId, id] = [new import_web315.PublicKey(poolInfo.programId), new import_web315.PublicKey(poolInfo.id)];
    const tickArrayLowerStartIndex = TickUtils.getTickArrayStartIndexByTick(ownerPosition.tickLower, poolInfo.config.tickSpacing);
    const tickArrayUpperStartIndex = TickUtils.getTickArrayStartIndexByTick(ownerPosition.tickUpper, poolInfo.config.tickSpacing);
    ...
    for (let i = 0; i < poolInfo.rewardDefaultInfos.length; i++) {
      rewardAccounts.push({
        poolRewardVault: new import_web315.PublicKey(poolKeys.rewardInfos[i].vault),
        ownerRewardVault: ownerInfo.rewardAccounts[i],
        rewardMint: new import_web315.PublicKey(poolInfo.rewardDefaultInfos[i].mint.address)
      });
    }
    const ins = [];
    const decreaseIns = this.decreaseLiquidityInstruction(poolProgramId, ownerInfo.wallet, positionNftAccount, personalPosition, id, protocolPosition, tickArrayLower, tickArrayUpper, ownerInfo.tokenAccountA, ownerInfo.tokenAccountB, new import_web315.PublicKey(poolKeys.vault.A), new import_web315.PublicKey(poolKeys.vault.B), new import_web315.PublicKey(poolInfo.mintA.address), new import_web315.PublicKey(poolInfo.mintB.address), rewardAccounts, liquidity, amountMinA, amountMinB, PoolUtils.isOverflowDefaultTickarrayBitmap(poolInfo.config.tickSpacing, [
      tickArrayLowerStartIndex,
      tickArrayUpperStartIndex
  ...
  static makeSwapBaseInInstructions({
    ...
    const [programId, id] = [new import_web315.PublicKey(poolInfo.programId), new import_web315.PublicKey(poolInfo.id)];
    const [mintAVault, mintBVault] = [new import_web315.PublicKey(poolKeys.vault.A), new import_web315.PublicKey(poolKeys.vault.B)];
    const [mintA, mintB] = [new import_web315.PublicKey(poolInfo.mintA.address), new import_web315.PublicKey(poolInfo.mintB.address)];
    const isInputMintA = poolInfo.mintA.address === inputMint.toString();
    const ins = [
      this.swapInstruction(programId, ownerInfo.wallet, id, new import_web315.PublicKey(poolInfo.config.id), isInputMintA ? ownerInfo.tokenAccountA : ownerInfo.tokenAccountB, isInputMintA ? ownerInfo.tokenAccountB : ownerInfo.tokenAccountA, isInputMintA ? mintAVault : mintBVault, isInputMintA ? mintBVault : mintAVault, isInputMintA ? mintA : mintB, isInputMintA ? mintB : mintA, remainingAccounts, observationId, amountIn, amountOutMin, sqrtPriceLimitX64, true, getPdaExBitmapAccount(programId, id).publicKey)
    ];
    return {
      signers: [],
      instructions: ins,
  ...
  static initRewardInstructions({
    ...
    const ins = [
      this.initRewardInstruction(programId, ownerInfo.wallet, id, operationId, new import_web315.PublicKey(poolInfo.config.id), ownerInfo.tokenAccount, rewardInfo.programId, rewardInfo.mint, poolRewardVault, rewardInfo.openTime, rewardInfo.endTime, rewardInfo.emissionsPerSecondX64)
    ];
    return {
  ...
  static setRewardInstructions({
    ...
    for (let index = 0; index < poolInfo.rewardDefaultInfos.length; index++)
      if (poolInfo.rewardDefaultInfos[index].mint.address === rewardInfo.mint.toString()) {
        rewardIndex = index;
        rewardVault = new import_web315.PublicKey(poolKeys.rewardInfos[index].vault);
        rewardMint = new import_web315.PublicKey(poolKeys.rewardInfos[index].mint.address);
      }
    ...
    const operationId = getPdaOperationAccount(programId).publicKey;
    const ins = [
      this.setRewardInstruction(programId, ownerInfo.wallet, id, operationId, new import_web315.PublicKey(poolInfo.config.id), ownerInfo.tokenAccount, rewardVault, rewardMint, rewardIndex, rewardInfo.openTime, rewardInfo.endTime, rewardInfo.emissionsPerSecondX64)
    ];
    return {
  ...
  static async makeLockPositions({
    ...
    let lockNftMint;
    if (getEphemeralSigners) {
      lockNftMint = new import_web315.PublicKey((await getEphemeralSigners(1))[0]);
    } else {
      const _k = import_web315.Keypair.generate();
      signers.push(_k);
  ...
  static harvestLockPositionInstruction(props) {
    const [poolProgramId, poolId] = [new import_web315.PublicKey(props.poolKeys.programId), new import_web315.PublicKey(props.poolKeys.id)];
    ...
    for (let i = 0; i < props.poolKeys.rewardInfos.length; i++) {
      rewardAccounts.push({
        poolRewardVault: new import_web315.PublicKey(props.poolKeys.rewardInfos[i].vault),
        ownerRewardVault: props.ownerRewardAccounts[i],
        rewardMint: new import_web315.PublicKey(props.poolKeys.rewardInfos[i].mint.address)
      });
    }
    const remainingAccounts = [
      ...rewardAccounts.map((i) => [
    ...
    const keys = [
      ...
      { pubkey: poolId, isSigner: false, isWritable: true },
      { pubkey: protocolPosition, isSigner: false, isWritable: true },
      { pubkey: new import_web315.PublicKey(props.poolKeys.vault.A), isSigner: false, isWritable: true },
      { pubkey: new import_web315.PublicKey(props.poolKeys.vault.B), isSigner: false, isWritable: true },
      { pubkey: tickArrayLower, isSigner: false, isWritable: true },
      { pubkey: tickArrayUpper, isSigner: false, isWritable: true },
      ...
      { pubkey: new import_web315.PublicKey(props.poolKeys.mintA.address), isSigner: false, isWritable: false },
      { pubkey: new import_web315.PublicKey(props.poolKeys.mintB.address), isSigner: false, isWritable: false },
      ...remainingAccounts
    ];
    return new import_web315.TransactionInstruction({
      keys,
...
var LIQUIDITY_FEES_NUMERATOR = new import_bn18.default(25);
var LIQUIDITY_FEES_DENOMINATOR = new import_bn18.default(1e4);
...
function makeAddLiquidityInstruction(params) {
  ...
  const keys = [
    ...
    accountMeta({ pubkey: new import_web318.PublicKey(poolInfo.id) }),
    accountMeta({ pubkey: new import_web318.PublicKey(poolKeys.authority), isWritable: false }),
    accountMeta({ pubkey: new import_web318.PublicKey(poolKeys.openOrders), isWritable: false }),
    accountMeta({ pubkey: new import_web318.PublicKey(poolKeys.targetOrders) }),
    accountMeta({ pubkey: new import_web318.PublicKey(poolInfo.lpMint.address) }),
    accountMeta({ pubkey: new import_web318.PublicKey(poolKeys.vault.A) }),
    accountMeta({ pubkey: new import_web318.PublicKey(poolKeys.vault.B) })
  ];
  if (poolInfo.pooltype.includes("StablePool")) {
    keys.push(accountMeta({ pubkey: MODEL_DATA_PUBKEY }));
  }
  keys.push(accountMeta({ pubkey: new import_web318.PublicKey(poolInfo.marketId), isWritable: false }), accountMeta({ pubkey: userKeys.baseTokenAccount }), accountMeta({ pubkey: userKeys.quoteTokenAccount }), accountMeta({ pubkey: userKeys.lpTokenAccount }), accountMeta({ pubkey: userKeys.owner, isWritable: false, isSigner: true }), accountMeta({ pubkey: new import_web318.PublicKey(poolKeys.marketEventQueue), isWritable: false }));
  return new import_web318.TransactionInstruction({
    programId: new import_web318.PublicKey(poolInfo.programId),
    keys,
    data
  });
}
function removeLiquidityInstruction(params) {
  ...
  return new import_web318.TransactionInstruction({ programId: poolKeys.programId, keys: [] });
}
function createPoolV4InstructionV2({
  ...
  const keys = [
    ...
    { pubkey: import_web318.SystemProgram.programId, isSigner: false, isWritable: false },
    { pubkey: RENT_PROGRAM_ID, isSigner: false, isWritable: false },
  ...
  return {
    instruction: new import_web318.TransactionInstruction({
      keys,
      programId,
      data
    }),
...
function getSerumAssociatedAuthority({ programId, marketId }) {
  ...
  while (nonce < 100) {
    try {
      ...
      publicKey2 = import_web319.PublicKey.createProgramAddressSync(seedsWithNonce, programId);
    } catch (err) {
...
function generatePubKey({
  ...
  const seed = assignSeed ? btoa(assignSeed).slice(0, 32) : import_web320.Keypair.generate().publicKey.toBase58().slice(0, 32);
...
function createWithSeed(fromPublicKey, seed, programId) {
  ...
  return new import_web320.PublicKey(publicKeyBytes);
}
...
function getAssociatedPoolKeys({
  ...
  return {
    ...
    marketId,
    marketAuthority,
    lookupTableAccount: import_web322.PublicKey.default,
...
var toAmmComputePoolInfo = (poolData) => {
  const data = {};
  const tokenProgramStr = import_spl_token13.TOKEN_PROGRAM_ID.toBase58();
...
function initializeMarket({
  ...
  const keys = [
    ...
    {
      pubkey: marketInfo.authority ? marketInfo.quoteMint : import_web323.SYSVAR_RENT_PUBKEY,
      isSigner: false,
      isWritable: false
    }
  ...
  return new import_web323.TransactionInstruction({
    keys,
    programId,
    data
  });
...
async function makeCreateMarketInstruction({
  ...
  const tx1 = new import_web323.Transaction();
  const accountLamports = await connection.getMinimumBalanceForRentExemption(165);
  tx1.add(import_web323.SystemProgram.createAccountWithSeed({
    fromPubkey: wallet,
    basePubkey: wallet,
  ...
  }), import_web323.SystemProgram.createAccountWithSeed({
    fromPubkey: wallet,
    basePubkey: wallet,
    ...
    space: 165,
    programId: import_spl_token14.TOKEN_PROGRAM_ID
  }), (0, import_spl_token14.createInitializeAccountInstruction)(marketInfo.baseVault.publicKey, marketInfo.baseMint, marketInfo.vaultOwner), (0, import_spl_token14.createInitializeAccountInstruction)(marketInfo.quoteVault.publicKey, marketInfo.quoteMint, marketInfo.vaultOwner), import_web323.SystemProgram.createAccountWithSeed({
    fromPubkey: wallet,
    basePubkey: wallet,
  ...
  const tx2 = new import_web323.Transaction();
  tx2.add(import_web323.SystemProgram.createAccountWithSeed({
    fromPubkey: wallet,
    basePubkey: wallet,
...
var LiquidityModule = class extends ModuleBase {
  ...
  async addLiquidity(params) {
    ...
    const lpTokenAccount = await account.getCreatedTokenAccount({
      mint: new import_web325.PublicKey(poolInfo.lpMint.address)
    });
  ...
  async removeLiquidity(params) {
    ...
    const [baseMint, quoteMint, lpMint] = [
      new import_web325.PublicKey(poolInfo.mintA.address),
      new import_web325.PublicKey(poolInfo.mintB.address),
      new import_web325.PublicKey(poolInfo.lpMint.address)
    ];
  ...
  async removeAllLpAndCreateClmmPosition({
    ...
    tokenProgram = import_spl_token16.TOKEN_PROGRAM_ID,
    ...
    for (const item of this.scope.account.tokenAccountRawInfos) {
      if (mintToAccount[item.accountInfo.mint.toString()] === void 0 || getATAAddress(this.scope.ownerPubKey, item.accountInfo.mint, import_spl_token16.TOKEN_PROGRAM_ID).publicKey.equals(item.pubkey)) {
    ...
    const { account: baseTokenAccount, instructionParams: ownerTokenAccountBaseInstruction } = await this.scope.account.getOrCreateTokenAccount({
      tokenProgram: import_spl_token16.TOKEN_PROGRAM_ID,
      mint: new import_web325.PublicKey(poolInfo.mintA.address),
      owner: this.scope.ownerPubKey,
    ...
    const { account: quoteTokenAccount, instructionParams: ownerTokenAccountQuoteInstruction } = await this.scope.account.getOrCreateTokenAccount({
      tokenProgram: import_spl_token16.TOKEN_PROGRAM_ID,
      mint: new import_web325.PublicKey(poolInfo.mintB.address),
      owner: this.scope.ownerPubKey,
    ...
    if (farmInfo !== void 0 && !userFarmLpAmount?.isZero()) {
      ...
      const ledger = getAssociatedLedgerAccount({
        programId: new import_web325.PublicKey(farmInfo.programId),
        poolId: new import_web325.PublicKey(farmInfo.id),
        owner: this.scope.ownerPubKey,
        version: farmVersion
      });
      ...
      if (farmVersion !== 6 && !ledgerInfo) {
        const { instruction, instructionType } = createAssociatedLedgerAccountInstruction({
          id: new import_web325.PublicKey(farmInfo.id),
          programId: new import_web325.PublicKey(farmInfo.programId),
          version: farmVersion,
          ledger,
          owner: this.scope.ownerPubKey
      ...
      for (const item of farmInfo.rewardInfos) {
        ...
        if (mintToAccount[item.mint.address])
          ...
          const { account: farmRewardAccount, instructionParams: ownerTokenAccountFarmInstruction } = await this.scope.account.getOrCreateTokenAccount({
            mint: new import_web325.PublicKey(item.mint.address),
            tokenProgram,
            owner: this.scope.ownerPubKey,
  ...
  async createPoolV4({
    ...
    const mintAUseSOLBalance = ownerInfo.useSOLBalance && baseMintInfo.mint.equals(import_spl_token16.NATIVE_MINT);
    const mintBUseSOLBalance = ownerInfo.useSOLBalance && quoteMintInfo.mint.equals(import_spl_token16.NATIVE_MINT);
    const txBuilder = this.createTxBuilder(feePayer);
  ...
  async createMarketAndPoolV4({
    ...
    const baseVault = generatePubKey({
      fromPublicKey: wallet,
      programId: import_spl_token16.TOKEN_PROGRAM_ID,
    ...
    function getVaultOwnerAndNonce() {
      ...
      while (true) {
        try {
          const vaultOwner2 = import_web325.PublicKey.createProgramAddressSync([market.publicKey.toBuffer(), vaultSignerNonce2.toArrayLike(Buffer, "le", 8)], marketProgram);
    ...
    if (txVersion === 0 /* V0 */)
      return txBuilder.sizeCheckBuildV0({
        ...
        address: {
          ...
          baseMint: new import_web325.PublicKey(baseMintInfo.mint),
          quoteMint: new import_web325.PublicKey(quoteMintInfo.mint),
          ...createPoolKeys
        }
      });
  ...
  async swap({
    ...
    const { account: _tokenAccountIn, instructionParams: ownerTokenAccountBaseInstruction } = await this.scope.account.getOrCreateTokenAccount({
      tokenProgram: import_spl_token16.TOKEN_PROGRAM_ID,
      mint: new import_web325.PublicKey(tokenIn.address),
      owner: this.scope.ownerPubKey,
    ...
    const { account: _tokenAccountOut, instructionParams: ownerTokenAccountQuoteInstruction } = await this.scope.account.getOrCreateTokenAccount({
      tokenProgram: import_spl_token16.TOKEN_PROGRAM_ID,
      mint: new import_web325.PublicKey(tokenOut.address),
      owner: this.scope.ownerPubKey,
      createInfo: {
        payer: this.scope.ownerPubKey,
        amount: 0
  ...
  async getRpcPoolInfos(poolIds, config2) {
    const accounts = await getMultipleAccountsInfoWithCustomFlags(this.scope.connection, poolIds.map((i) => ({ pubkey: new import_web325.PublicKey(i) })), config2);
    const poolInfos = {};
    ...
    const vaultInfo = {};
    const vaultAccountInfo = await getMultipleAccountsInfoWithCustomFlags(this.scope.connection, needFetchVaults.map((i) => ({ pubkey: new import_web325.PublicKey(i) })), config2);
    for (let i = 0; i < needFetchVaults.length; i++) {
      ...
      vaultInfo[String(needFetchVaults[i])] = new import_bn23.default(import_spl_token16.AccountLayout.decode(vaultItemInfo.data).amount.toString());
    }
    const returnData = {};
