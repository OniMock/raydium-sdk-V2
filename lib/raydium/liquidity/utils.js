...
async function simulateMultipleInstruction(connection, instructions, keyword, batchRequest = true) {
  const feePayer = new import_web3.PublicKey("RaydiumSimuLateTransaction11111111111111111");
  const transactions = [];
  let transaction = new import_web3.Transaction();
  transaction.feePayer = feePayer;
  for (const instruction of instructions) {
    if (!forecastTransactionSize([...transaction.instructions, instruction], [feePayer])) {
      transactions.push(transaction);
      transaction = new import_web3.Transaction();
      transaction.feePayer = feePayer;
    }
...
function findProgramAddress(seeds, programId) {
  const [publicKey2, nonce] = import_web3.PublicKey.findProgramAddressSync(seeds, programId);
...
// src/common/bignumber.ts
var BN_ZERO = new import_bn5.default(0);
var BN_ONE = new import_bn5.default(1);
var BN_TWO = new import_bn5.default(2);
var BN_THREE = new import_bn5.default(3);
var BN_FIVE = new import_bn5.default(5);
var BN_TEN = new import_bn5.default(10);
var BN_100 = new import_bn5.default(100);
var BN_1000 = new import_bn5.default(1e3);
var BN_10000 = new import_bn5.default(1e4);
...
var FEE_RATE_DENOMINATOR_VALUE = new import_bn7.default(1e6);
