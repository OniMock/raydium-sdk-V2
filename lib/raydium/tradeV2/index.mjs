...
function route1Instruction(programId, poolInfoA, poolKeyA, poolKeyB, userSourceToken, userRouteToken, userPdaAccount, ownerWallet, inputMint, amountIn, amountOut, tickArrayA) {
  ...
  const keys = [
    ...
    { pubkey: TOKEN_PROGRAM_ID14, isSigner: false, isWritable: false },
    { pubkey: new PublicKey24(poolKeyA.programId), isSigner: false, isWritable: false },
    { pubkey: new PublicKey24(poolKeyA.id), isSigner: false, isWritable: true },
    { pubkey: new PublicKey24(poolKeyB.id), isSigner: false, isWritable: true },
  ...
  if (poolInfoA.type === "Concentrated") {
    ...
    keys.push(...[
      ...
      { pubkey: poolKey.id, isSigner: false, isWritable: true },
      { pubkey: new PublicKey24("CDSr3ssLcRB6XYPJwAfFt18MZvEZp4LjHcvzBVZ45duo"), isSigner: false, isWritable: false },
...
function route2Instruction(programId, poolInfoB, poolKeyA, poolKeyB, userRouteToken, userDestinationToken, userPdaAccount, ownerWallet, routeMint, tickArrayB) {
  ...
  const keys = [
    { pubkey: SystemProgram7.programId, isSigner: false, isWritable: false },
    { pubkey: TOKEN_PROGRAM_ID14, isSigner: false, isWritable: false },
    { pubkey: new PublicKey24(String(poolKeyB.programId)), isSigner: false, isWritable: false },
    { pubkey: new PublicKey24(String(poolKeyB.id)), isSigner: false, isWritable: true },
    { pubkey: new PublicKey24(String(poolKeyA.id)), isSigner: false, isWritable: true },
    { pubkey: userRouteToken, isSigner: false, isWritable: true },
...
function swapBaseInAutoAccount({
  ...
  for (let index = 0; index < poolKeys.length; index++) {
    ...
    keys.push(accountMeta({ pubkey: new PublicKey24(_poolKey.programId), isWritable: false }));
    if (index === poolKeys.length - 1) {
      ...
      if (cacheAccount[mint] === void 0) {
        const ata = getATAAddress(wallet, new PublicKey24(mint), _poolKey.programId === ALL_PROGRAM_ID.CLMM_PROGRAM_ID.toBase58() || _poolKey.programId === ALL_PROGRAM_ID.CREATE_CPMM_POOL_PROGRAM.toBase58() ? new PublicKey24(inputIsA ? _poolKey.mintB.programId : _poolKey.mintA.programId) : TOKEN_PROGRAM_ID14).publicKey;
        cacheAccount[mint] = ata;
      }
      keys.push(accountMeta({ pubkey: cacheAccount[mint] }));
    }
    keys.push(accountMeta({ pubkey: new PublicKey24(_routeInfo.inputMint) }));
    keys.push(accountMeta({ pubkey: new PublicKey24(_routeInfo.outputMint) }));
    if (_poolKey.programId === ALL_PROGRAM_ID.CLMM_PROGRAM_ID.toBase58()) {
      const poolKey = _poolKey;
      keys.push(accountMeta({ pubkey: new PublicKey24(poolKey.config.id) }));
      keys.push(accountMeta({ pubkey: new PublicKey24(poolKey.id) }));
      keys.push(accountMeta({ pubkey: new PublicKey24(inputIsA ? poolKey.vault.A : poolKey.vault.B) }));
      keys.push(accountMeta({ pubkey: new PublicKey24(inputIsA ? poolKey.vault.B : poolKey.vault.A) }));
      keys.push(accountMeta({ pubkey: new PublicKey24(poolKey.observationId) }));
      keys.push(accountMeta({ pubkey: MEMO_PROGRAM_ID2, isWritable: false }));
      keys.push(accountMeta({ pubkey: new PublicKey24(poolKey.exBitmapAccount) }));
      ...
      const poolKey = _poolKey;
      keys.push(accountMeta({ pubkey: new PublicKey24(poolKey.id) }));
      keys.push(accountMeta({ pubkey: new PublicKey24(poolKey.authority), isWritable: false }));
      keys.push(accountMeta({ pubkey: new PublicKey24(poolKey.marketProgramId), isWritable: false }));
      keys.push(accountMeta({ pubkey: new PublicKey24(poolKey.marketAuthority), isWritable: false }));
      keys.push(accountMeta({ pubkey: LIQUIDITY_POOL_PROGRAM_ID_V5_MODEL, isWritable: false }));
      keys.push(accountMeta({ pubkey: new PublicKey24(poolKey.openOrders) }));
      keys.push(accountMeta({ pubkey: new PublicKey24(poolKey.vault.A) }));
      keys.push(accountMeta({ pubkey: new PublicKey24(poolKey.vault.B) }));
      keys.push(accountMeta({ pubkey: new PublicKey24(poolKey.marketId) }));
      keys.push(accountMeta({ pubkey: new PublicKey24(poolKey.marketBids) }));
      keys.push(accountMeta({ pubkey: new PublicKey24(poolKey.marketAsks) }));
      keys.push(accountMeta({ pubkey: new PublicKey24(poolKey.marketEventQueue) }));
      keys.push(accountMeta({ pubkey: new PublicKey24(poolKey.marketBaseVault) }));
      keys.push(accountMeta({ pubkey: new PublicKey24(poolKey.marketQuoteVault) }));
      ...
      const poolKey = _poolKey;
      keys.push(accountMeta({ pubkey: new PublicKey24(poolKey.authority) }));
      keys.push(accountMeta({ pubkey: new PublicKey24(poolKey.config.id) }));
      keys.push(accountMeta({ pubkey: new PublicKey24(poolKey.id) }));
      keys.push(accountMeta({ pubkey: new PublicKey24(inputIsA ? poolKey.vault.A : poolKey.vault.B) }));
      keys.push(accountMeta({ pubkey: new PublicKey24(inputIsA ? poolKey.vault.B : poolKey.vault.A) }));
  ...
  dataLayout.encode({
    insId: 0,
    amountIn: amount,
    amountOut: new BN23(routeInfo.data.otherAmountThreshold),
    clmmPriceLimit
  }, data);
  return new TransactionInstruction7({
    keys,
...
function swapBaseOutAutoAccount({
  ...
  for (let index = poolKeys.length - 1; index >= 0; index--) {
    ...
    const _poolKey = poolKeys[index];
    const inputIsA = _routeInfo.inputMint === _poolKey.mintA.address;
    keys.push(accountMeta({ pubkey: new PublicKey24(_poolKey.programId) }));
    if (index === 0) {
      keys.push(accountMeta({ pubkey: cacheAccount[_routeInfo.inputMint] }));
    } else {
      const mint = _routeInfo.inputMint;
      if (cacheAccount[mint] === void 0) {
        const ata = getATAAddress(wallet, new PublicKey24(mint), _poolKey.programId === ALL_PROGRAM_ID.CLMM_PROGRAM_ID.toBase58() || _poolKey.programId === ALL_PROGRAM_ID.CREATE_CPMM_POOL_PROGRAM.toBase58() ? new PublicKey24(inputIsA ? _poolKey.mintA.programId : _poolKey.mintB.programId) : TOKEN_PROGRAM_ID14).publicKey;
        cacheAccount[mint] = ata;
      }
      keys.push(accountMeta({ pubkey: cacheAccount[mint] }));
    }
  ...
  dataLayout.encode({
    insId: 1,
    amountIn: new BN23(routeInfo.data.otherAmountThreshold),
    amountOut: new BN23(routeInfo.data.outputAmount),
    clmmPriceLimit
  }, data);
  return new TransactionInstruction7({
    keys,
